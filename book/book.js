...
var $dtwrks$elm_book$ElmBook$ThemeOptions$background = F2(
	function (background_, theme) {
		return _Utils_update(
			theme,
...
var $author$project$TW$cls = function (utilities) {
	return $elm$html$Html$Attributes$class(utilities);
};
var $author$project$UI$auditFilterLegendTextAttr = $author$project$TW$cls('m-0 mb-2 text-[0.82rem] text-[var(--fg-muted)]');
var $author$project$UI$auditFilterTypeGroupAttr = $author$project$TW$cls('mt-1.5 pt-1.5');
...
var $author$project$UI$flexWrapGap2Attr = $author$project$TW$cls('flex flex-wrap gap-2');
var $author$project$UI$formFieldLabelBlockAttr = $author$project$TW$cls('block text-[0.82rem] font-medium text-[var(--fg-muted)]');
var $author$project$UI$formFieldMinW0Attr = $author$project$TW$cls('min-w-0');
var $author$project$UI$focusVisibleRingClass = 'focus-visible:outline-2 focus-visible:outline-[var(--focus-ring)] focus-visible:outline-offset-2';
var $author$project$UI$formTextInputClass = '[font-family:var(--font-ui)] text-[0.8125rem] px-[0.5rem] py-[0.3rem] mt-[0.1rem] mb-[0.2rem] rounded-lg border border-[var(--border-subtle)] bg-[var(--input-bg)] text-[var(--fg)] max-w-full box-border ' + $author$project$UI$focusVisibleRingClass;
var $author$project$UI$formTextInputAuditFilterClass = $author$project$UI$formTextInputClass + ' mt-0 w-full max-w-full';
var $author$project$UI$formTextInputAuditFilterAttr = $author$project$TW$cls($author$project$UI$formTextInputAuditFilterClass);
var $author$project$UI$hostAdminAuditFiltersCardAttr = $author$project$TW$cls('shrink-0 border border-[var(--border)] bg-[var(--chrome-bg)] p-3');
var $author$project$UI$hostAdminAuditFiltersGridAttr = $author$project$TW$cls('grid grid-cols-3 gap-3');
...
var $author$project$UI$Button$toggleChip = F2(
	function (extraAttrs, _v0) {
		var pressed = _v0.pressed;
		var onClick = _v0.onClick;
		var label = _v0.label;
		var stateClass = pressed ? 'bg-[var(--chip-on-bg)] text-[var(--chip-on-fg)] border-[var(--chip-on-border)] shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]' : 'bg-[var(--chip-off-bg)] text-[var(--chip-off-fg)] border-[var(--chip-off-border)] hover:bg-[var(--chrome-bg)]';
		return A2(
			$elm$html$Html$button,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls('[font-family:inherit] inline-flex items-center text-[0.8125rem] leading-snug px-[0.6rem] py-[0.3rem] border rounded-full font-medium ' + ('transition-[background-color,border-color,color] duration-100 cursor-pointer ' + ('focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--focus-ring)] focus-visible:outline-offset-2 ' + stateClass))),
				A2(
					$elm$core$List$cons,
...
var $author$project$UI$wikiAdminAuditFiltersGridAttr = $author$project$TW$cls('grid grid-cols-2 gap-3');
var $author$project$Chapters$Admin$chapterAuditFilters = A2(
	...
	_List_fromArray(
		[
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$hostAdminAuditFiltersCardAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$hostAdminAuditFiltersGridAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$formFieldMinW0Attr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$label,
										_List_fromArray(
											[$author$project$UI$formFieldLabelBlockAttr]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$author$project$UI$formTextInputAuditFilterAttr,
												$elm$html$Html$Attributes$placeholder('Filter by user…')
											]),
										_List_Nil)
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$UI$formTextInputAuditFilterAttr,
												$elm$html$Html$Attributes$placeholder('Filter by page…')
											]),
										_List_Nil)
									])),
								A2(
						...
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$auditFilterTypeGroupAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$p,
								_List_fromArray(
									[$author$project$UI$auditFilterLegendTextAttr]),
								_List_fromArray(
									[
										$elm$html$Html$text('Filter by event type')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$flexWrapGap2Attr]),
								_List_fromArray(
									[
										A2(
										$author$project$UI$Button$toggleChip,
										_List_Nil,
										{
											label: 'Page created',
											onClick: $dtwrks$elm_book$ElmBook$Actions$logAction('chip: page-created toggled'),
											pressed: true
										}),
										A2(
										$author$project$UI$Button$toggleChip,
										...
										{
											label: 'Page edited',
											onClick: $dtwrks$elm_book$ElmBook$Actions$logAction('chip: page-edited toggled'),
											pressed: false
										}),
										A2(
										$author$project$UI$Button$toggleChip,
										...
										{
											label: 'Page deleted',
											onClick: $dtwrks$elm_book$ElmBook$Actions$logAction('chip: page-deleted toggled'),
											pressed: true
										})
									]))
							]))
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$wikiAdminAuditFiltersGridAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$div,
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Audit Filters'));
...
var $dtwrks$elm_book$ElmBook$Actions$updateState = function (fn) {
...
var $author$project$Chapters$FormControls$chapterChips = A2(
		...
		[
			...
			function (state) {
				return A2(
					...
					{
						label: 'Elm',
						onClick: $dtwrks$elm_book$ElmBook$Actions$updateState(
							function (s) {
								return _Utils_update(
									s,
									{chip1: !s.chip1});
			...
			function (state) {
				return A2(
					...
					_List_fromArray(
						[
							$author$project$TW$cls('flex flex-wrap gap-2')
						]),
					_List_fromArray(
						[
							A2(
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Togglable Chips'));
var $author$project$UI$Button$class = '[font-family:inherit] text-[0.9375rem] font-bold tracking-[0.01em] px-[0.875rem] py-[0.4rem] mt-[0.1rem] mr-[0.15rem] mb-[0.1rem] ml-0 rounded-lg bg-[var(--btn-bg)] text-[var(--btn-fg)] border border-[var(--btn-border)] cursor-pointer hover:brightness-[1.08] dark:hover:brightness-[1.12] dark:hover:border-[var(--border-dash)] disabled:opacity-[0.55] disabled:cursor-not-allowed';
var $author$project$UI$FocusVisible$class = 'focus-visible:outline-2 focus-visible:outline-[var(--focus-ring)] focus-visible:outline-offset-2';
var $author$project$UI$FocusVisible$on = function (attrs) {
	return A2(
		$elm$core$List$cons,
		$author$project$TW$cls($author$project$UI$FocusVisible$class),
		attrs);
};
var $author$project$UI$Button$button = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$button,
			$author$project$UI$FocusVisible$on(
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls($author$project$UI$Button$class),
					attrs)),
			children);
	});
...
var $author$project$UI$classAttr = $author$project$TW$cls;
var $author$project$UI$Button$dangerClass = '[font-family:inherit] text-[0.9375rem] font-bold tracking-[0.01em] px-[0.875rem] py-[0.4rem] mt-[0.1rem] mr-[0.15rem] mb-[0.1rem] ml-0 rounded-lg bg-[var(--danger-btn-bg)] text-[var(--danger-btn-fg)] border border-[var(--danger-btn-bg)] cursor-pointer hover:brightness-[1.12] disabled:opacity-[0.55] disabled:cursor-not-allowed';
var $author$project$UI$Button$dangerButton = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$button,
			$author$project$UI$FocusVisible$on(
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls($author$project$UI$Button$dangerClass),
					attrs)),
			children);
	});
var $elm$html$Html$fieldset = _VirtualDom_node('fieldset');
var $author$project$UI$Textarea$formChromeClass = 'box-border px-[0.5rem] py-[0.3rem] mt-[0.1rem] mb-[0.2rem] rounded-lg border border-[var(--border-subtle)] bg-[var(--input-bg)] text-[var(--fg)] max-w-full w-full max-w-[48rem]';
var $author$project$UI$Textarea$formShellClass = '[font-family:var(--font-ui)] text-[0.8125rem] ' + $author$project$UI$Textarea$formChromeClass;
var $author$project$UI$Textarea$formCompactClass = $author$project$UI$Textarea$formShellClass + ' min-h-0';
var $author$project$UI$Textarea$formCompact = function (attrs) {
	return $author$project$UI$FocusVisible$on(
		A2(
			$elm$core$List$cons,
			$author$project$TW$cls($author$project$UI$Textarea$formCompactClass),
			attrs));
};
var $author$project$UI$gridCellStackCol1Row3Attr = $author$project$TW$cls('flex min-h-0 min-w-0 flex-col gap-1 col-start-1 row-start-3');
var $author$project$UI$gridCellStackCol2Row3Attr = $author$project$TW$cls('flex min-h-0 min-w-0 flex-col gap-1 col-start-2 row-start-3');
var $elm$html$Html$h3 = _VirtualDom_node('h3');
var $author$project$UI$Heading$reviewDiffCellHeadingClass = 'm-0 !mt-0 !mb-0 shrink-0 text-sm font-semibold leading-tight text-[var(--fg)]';
var $author$project$UI$Heading$gridHeadingCol1 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h3,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$reviewDiffCellHeadingClass + ' col-start-1 row-start-1'),
				attrs),
			children);
	});
var $author$project$UI$Heading$gridHeadingCol2 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h3,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$reviewDiffCellHeadingClass + ' col-start-2 row-start-1'),
				attrs),
			children);
	});
var $author$project$UI$Heading$gridHeadingPrimaryCol1 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h3,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls('m-0 !mt-0 !mb-0 shrink-0 text-sm font-semibold leading-tight text-[var(--fg)] col-start-1 row-start-1'),
				attrs),
			children);
	});
var $author$project$UI$Heading$gridHeadingSecondaryCol2 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h3,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls('m-0 !mt-0 !mb-0 shrink-0 text-sm font-semibold leading-tight text-[var(--fg-muted)] col-start-2 row-start-1'),
				attrs),
			children);
	});
var $author$project$UI$gridTwoColEditorStrAttr = $author$project$TW$cls('grid min-w-0 grid-cols-2 gap-4 items-stretch');
var $elm$html$Html$legend = _VirtualDom_node('legend');
var $author$project$UI$markdownContainerClass = 'markdown-body block max-w-[52rem] text-[1.125rem] leading-[1.6] [font-family:var(--font-serif)]';
var $author$project$UI$Textarea$markdownPanelCellClass = ' h-full min-h-0 flex-1';
var $author$project$UI$Textarea$markdownClass = '[font-family:var(--font-mono)] [font-variant-ligatures:none] text-[0.85rem] leading-[1.4]';
var $author$project$UI$Textarea$markdownPanelBaseClass = $author$project$UI$Textarea$markdownClass + ' box-border m-0 min-h-[12rem] max-h-[24rem] w-full flex-1 overflow-auto border border-[var(--border)] bg-[var(--input-bg)] p-2 whitespace-pre-wrap break-words';
var $author$project$UI$Textarea$markdownPanelEditableClass = $author$project$UI$Textarea$markdownPanelBaseClass + ' resize-y text-[var(--fg)]';
var $author$project$UI$Textarea$markdownEditableCell = function (attrs) {
	return A2(
		$elm$core$List$cons,
		$author$project$TW$cls(
			_Utils_ap($author$project$UI$Textarea$markdownPanelEditableClass, $author$project$UI$Textarea$markdownPanelCellClass)),
		attrs);
};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$UI$Heading$sidebarSubheadingTrackingClass = 'tracking-[0.04em]';
var $author$project$UI$Heading$markdownHeading1Class = 'mt-[1.5rem] mb-[0.5rem] font-semibold leading-[1.2] ' + ($author$project$UI$Heading$sidebarSubheadingTrackingClass + ' text-[var(--fg)] text-[2.5rem]');
var $author$project$UI$Heading$markdownHeading1 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h1,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$markdownHeading1Class),
				attrs),
			children);
	});
var $author$project$UI$contentParagraphClass = 'my-[1rem] leading-[1.6] [font-family:var(--font-serif)]';
var $author$project$UI$markdownParagraphClass = $author$project$UI$contentParagraphClass + ' leading-[1.6]';
var $author$project$UI$markdownPreviewScrollClass = 'max-h-[24rem] min-w-0 overflow-auto border border-[var(--border)] bg-[var(--bg)] p-2 [font-family:var(--font-serif)]';
var $author$project$UI$markdownPreviewScrollMinFlexAttr = $author$project$TW$cls($author$project$UI$markdownPreviewScrollClass + ' min-h-0 flex-1');
var $author$project$UI$markdownPreviewScrollMinFlexFullHeightAttr = $author$project$TW$cls($author$project$UI$markdownPreviewScrollClass + ' min-h-0 h-full flex-1');
var $author$project$UI$Textarea$markdownPanelReadonlyClass = $author$project$UI$Textarea$markdownPanelBaseClass + ' cursor-default resize-none text-[color:color-mix(in_srgb,var(--fg)_50%,transparent)]';
var $author$project$UI$Textarea$markdownReadonly = function (attrs) {
	return A2(
		$elm$core$List$cons,
		$author$project$TW$cls($author$project$UI$Textarea$markdownPanelReadonlyClass + ''),
		attrs);
};
var $author$project$UI$Textarea$markdownReadonlyCol1Row2 = function (attrs) {
	return A2(
		$elm$core$List$cons,
		$author$project$TW$cls($author$project$UI$Textarea$markdownPanelReadonlyClass + ($author$project$UI$Textarea$markdownPanelCellClass + ' min-w-0 col-start-1 row-start-2')),
		attrs);
};
var $author$project$UI$Textarea$markdownReadonlyGridCol2Row2 = function (attrs) {
	return A2(
		$elm$core$List$cons,
		$author$project$TW$cls($author$project$UI$Textarea$markdownPanelReadonlyClass + ($author$project$UI$Textarea$markdownPanelCellClass + ' min-w-0 col-start-2 row-start-2')),
		attrs);
};
var $author$project$UI$Textarea$markdownReadonlyWithExtra = F2(
	function (extraClass, attrs) {
		return A2(
			$elm$core$List$cons,
			$author$project$TW$cls(
				_Utils_ap($author$project$UI$Textarea$markdownPanelReadonlyClass, extraClass)),
			attrs);
	});
var $elm$html$Html$Attributes$name = $elm$html$Html$Attributes$stringProperty('name');
var $author$project$UI$newPageEditorMarkdownPreviewCellClass = 'flex min-h-0 min-w-0 flex-col gap-1 h-full';
var $author$project$UI$newPageEditorMarkdownPreviewCellAttr = $author$project$TW$cls($author$project$UI$newPageEditorMarkdownPreviewCellClass);
var $author$project$UI$Heading$panelHeadingPrimaryClass = 'm-0 !mt-0 !mb-0 shrink-0 text-sm font-semibold leading-tight text-[var(--fg)]';
var $author$project$UI$Heading$panelHeadingPrimary = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h3,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$panelHeadingPrimaryClass),
				attrs),
			children);
	});
var $author$project$UI$Heading$panelHeadingSecondaryClass = 'm-0 !mt-0 !mb-0 shrink-0 text-sm font-semibold leading-tight text-[var(--fg-muted)]';
var $author$project$UI$Heading$panelHeadingSecondary = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h3,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$panelHeadingSecondaryClass),
				attrs),
			children);
	});
var $elm$html$Html$Attributes$readonly = $elm$html$Html$Attributes$boolProperty('readOnly');
var $author$project$UI$reviewDeletePagePreviewTitleAttr = $author$project$TW$cls('m-0 text-sm font-semibold text-[var(--fg-muted)]');
var $author$project$UI$reviewDiffNewPagePreviewColShellAttr = $author$project$TW$cls('flex min-h-0 min-w-0 h-full col-start-2 row-start-2');
var $author$project$UI$reviewFieldsetAttr = $author$project$TW$cls('mt-4 flex flex-col gap-3 border border-[var(--border)] p-3 max-w-[42rem]');
var $author$project$UI$reviewLegendAttr = $author$project$TW$cls('px-1 text-[var(--fg)]');
var $author$project$UI$reviewNestedNoteColumnAttr = $author$project$TW$cls('flex flex-col gap-1.5');
var $author$project$UI$reviewOptionLabelStrongAttr = $author$project$TW$cls('font-medium');
var $author$project$UI$reviewRadioColumnAttr = $author$project$TW$cls('flex flex-col gap-3');
var $author$project$UI$reviewRadioRowAttr = $author$project$TW$cls('flex items-start gap-2 cursor-pointer');
var $elm$html$Html$strong = _VirtualDom_node('strong');
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $author$project$UI$submissionGridTight2ColAttr = $author$project$TW$cls('grid min-w-0 grid-cols-2 gap-x-3 gap-y-2');
var $author$project$UI$submissionStatusDangerLineAttr = $author$project$TW$cls('text-[var(--danger)] m-0 mt-2');
var $author$project$UI$mt3Mb3Attr = $author$project$TW$cls('mt-3 mb-3');
var $author$project$UI$submitActionsBarAttr = $author$project$UI$mt3Mb3Attr;
var $author$project$UI$submitSummaryParagraphAttr = $author$project$TW$cls('m-0 text-[0.95rem] leading-[1.45]');
var $elm$html$Html$textarea = _VirtualDom_node('textarea');
var $author$project$Chapters$Admin$chapterSubmissionFlow = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$gridTwoColEditorStrAttr,
						A2($elm$html$Html$Attributes$style, 'min-height', '14rem')
					]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$newPageEditorMarkdownPreviewCellAttr]),
						_List_fromArray(
							[
								A2(
								$author$project$UI$Heading$panelHeadingPrimary,
								_List_Nil,
								_List_fromArray(
									[
								...
								$author$project$UI$Textarea$markdownEditableCell(_List_Nil),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								A2(
								$author$project$UI$Heading$panelHeadingSecondary,
								_List_Nil,
								_List_fromArray(
									[
								...
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$markdownPreviewScrollMinFlexAttr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$div,
										_List_fromArray(
											[
												$author$project$TW$cls($author$project$UI$markdownContainerClass)
											]),
										_List_fromArray(
											[
												A2(
												$author$project$UI$Heading$markdownHeading1,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text('New Page')
												...
												_List_fromArray(
													[
														$author$project$TW$cls($author$project$UI$markdownParagraphClass)
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('Content goes here.')
													]))
											]))
									]))
							]))
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$classAttr('grid min-w-0 grid-cols-2 grid-rows-[auto_auto_auto] gap-4 items-stretch'),
						A2($elm$html$Html$Attributes$style, 'min-height', '14rem')
					]),
				_List_fromArray(
					[
						A2(
						$author$project$UI$Heading$gridHeadingCol1,
						_List_Nil,
						_List_fromArray(
							[
						...
						A2(
						$author$project$UI$Heading$gridHeadingCol2,
						_List_Nil,
						_List_fromArray(
							[
						...
						A2(
						$elm$html$Html$textarea,
						$author$project$UI$Textarea$markdownReadonlyCol1Row2(
							_List_fromArray(
								[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('# Original Title\n\nOriginal content.')
							])),
						A2(
						$elm$html$Html$textarea,
						$author$project$UI$Textarea$markdownReadonlyGridCol2Row2(
							_List_fromArray(
								[
									$elm$html$Html$Attributes$readonly(true)
								])),
						_List_fromArray(
							[
								$elm$html$Html$text('# New Title\n\nRevised content with changes.')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$gridCellStackCol1Row3Attr]),
						_List_fromArray(
							[
								A2(
								$author$project$UI$Heading$panelHeadingPrimary,
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Preview (before)')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Original content.')
													]))
											]))
									]))
							])),
						...
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$gridCellStackCol2Row3Attr]),
						_List_fromArray(
							[
								A2(
								$author$project$UI$Heading$panelHeadingPrimary,
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Preview (after)')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Revised content with changes.')
													]))
											]))
									]))
							]))
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$classAttr('grid min-w-0 grid-cols-2 grid-rows-[auto_1fr] gap-4 items-stretch'),
						A2($elm$html$Html$Attributes$style, 'min-height', '10rem')
					]),
				_List_fromArray(
					[
						A2(
						$author$project$UI$Heading$gridHeadingPrimaryCol1,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Proposed page')
							])),
						A2(
						$author$project$UI$Heading$gridHeadingSecondaryCol2,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Preview')
						...
						_List_fromArray(
							[
								$elm$html$Html$text('# A Brand New Page\n\nThis page doesn\'t exist yet.')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$reviewDiffNewPagePreviewColShellAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$markdownPreviewScrollMinFlexFullHeightAttr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$div,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('This page doesn\'t exist yet.')
													]))
											]))
									]))
							]))
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$p,
						_List_fromArray(
							[$author$project$UI$reviewDeletePagePreviewTitleAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('Current published content (will be deleted):')
							])),
						A2(
						$elm$html$Html$textarea,
						$author$project$UI$Textarea$markdownReadonly(
							_List_fromArray(
								[
									$elm$html$Html$Attributes$readonly(true)
								])),
						_List_fromArray(
							[
								$elm$html$Html$text('# Page to Delete\n\nThis content will be removed.')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[$author$project$UI$reviewFieldsetAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$legend,
						_List_fromArray(
							[$author$project$UI$reviewLegendAttr]),
						_List_fromArray(
							[
						...
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$reviewRadioColumnAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$label,
								_List_fromArray(
									[$author$project$UI$reviewRadioRowAttr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$input,
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$name('decision-demo'),
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[$author$project$UI$reviewOptionLabelStrongAttr]),
												_List_fromArray(
													[
												...
												$elm$html$Html$div,
												_List_fromArray(
													[$author$project$UI$reviewNestedNoteColumnAttr]),
												_List_fromArray(
													[
														A2(
														$elm$html$Html$textarea,
														$author$project$UI$Textarea$formCompact(
															_List_fromArray(
																[
																	$elm$html$Html$Attributes$placeholder('Optional note for the contributor…')
																])),
														_List_Nil)
													]))
											]))
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Request changes')
											]))
									])),
								A2(
								$elm$html$Html$label,
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$p,
						_List_fromArray(
							[$author$project$UI$submitSummaryParagraphAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('This edit proposes changes to the introduction section.')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$submitActionsBarAttr]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Submit edit')
									])),
								A2(
								$author$project$UI$Button$dangerButton,
								_List_Nil,
								_List_fromArray(
									[
						...
						$elm$html$Html$p,
						_List_fromArray(
							[$author$project$UI$submissionStatusDangerLineAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('This submission conflicts with a recent edit.')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$submissionGridTight2ColAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$TW$cls('text-[0.82rem] text-[var(--fg-muted)]')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Your version')
									]))
							])),
						A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Current published')
									]))
							])),
						A2(
						$elm$html$Html$textarea,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('# My edits\n\nContent I wrote.')
							])),
						A2(
						$elm$html$Html$textarea,
						A2(
							$author$project$UI$Textarea$markdownReadonlyWithExtra,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('# Published version\n\nContent that was published.')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$UI$classAttr($author$project$UI$markdownPreviewScrollClass)
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Content that was published.')
													]))
											]))
									]))
							]))
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Submission & Review Flow'));
var $author$project$UI$TableAlignTop = {$: 'TableAlignTop'};
var $elm$virtual_dom$VirtualDom$node = function (tag) {
	return _VirtualDom_node(
		_VirtualDom_noScript(tag));
};
var $elm$html$Html$node = $elm$virtual_dom$VirtualDom$node;
var $author$project$UI$auditLogCol = function (columnClass) {
	return A3(
		$elm$html$Html$node,
		'col',
		_List_fromArray(
			[
				$author$project$TW$cls(columnClass)
			]),
		_List_Nil);
};
var $author$project$UI$auditLogColGroup = function (columnClasses) {
	return A3(
		$elm$html$Html$node,
		'colgroup',
		_List_Nil,
		A2($elm$core$List$map, $author$project$UI$auditLogCol, columnClasses));
};
var $author$project$UI$auditTableHeaderCellClass = 'sticky top-0 z-[1] px-[0.55rem] py-[0.22rem] text-left align-top bg-[var(--chrome-bg)] font-semibold border-b border-[var(--border)]';
var $elm$html$Html$Attributes$scope = $elm$html$Html$Attributes$stringProperty('scope');
var $elm$html$Html$th = _VirtualDom_node('th');
var $elm$html$Html$tr = _VirtualDom_node('tr');
var $author$project$UI$auditLogHeaderRow = function (labels) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$author$project$TW$cls($author$project$UI$auditTableHeaderCellClass)
						]),
					_List_fromArray(
						[
...
var $author$project$UI$auditTableBaseClass = 'w-full table-auto border-separate border-spacing-0 text-[0.8125rem] leading-[1.35] border-[var(--border)] [&_th+th]:border-l [&_th+th]:border-[var(--border-dash)] [&_td+td]:border-l [&_td+td]:border-[var(--border-dash)] [&_tbody_tr:hover]:bg-[var(--table-row-hover)]';
var $elm$html$Html$Attributes$id = $elm$html$Html$Attributes$stringProperty('id');
var $elm$html$Html$table = _VirtualDom_node('table');
var $elm$html$Html$tbody = _VirtualDom_node('tbody');
var $elm$html$Html$thead = _VirtualDom_node('thead');
var $author$project$UI$auditLogTableView = function (config) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$author$project$TW$cls('flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$author$project$TW$cls('min-h-0 min-w-0 flex-1 overflow-auto overscroll-none')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id(config.tableId),
								$author$project$TW$cls($author$project$UI$auditTableBaseClass)
							]),
						_List_fromArray(
							[
								$author$project$UI$auditLogColGroup(config.columnClasses),
								A2(
								$elm$html$Html$thead,
								_List_Nil,
								_List_fromArray(
									[
										$author$project$UI$auditLogHeaderRow(config.headers)
									])),
								A2(
								$elm$html$Html$tbody,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id(config.tbodyId)
									]),
								config.rows)
							]))
					]))
...
var $author$project$UI$Heading$cardHeadingDanger = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h3,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls('m-0 mb-1.5 text-[0.8125rem] font-semibold text-[var(--danger)] leading-[1.2]'),
				attrs),
			children);
	});
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $author$project$UI$Heading$cardHeadingLg = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h2,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls('m-0 mb-2 text-[1.1rem] font-semibold text-[var(--fg)] leading-[1.2]'),
				attrs),
			children);
	});
var $author$project$UI$Heading$cardHeadingSm = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h2,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls('m-0 mb-2 text-[0.8125rem] font-semibold text-[var(--fg)] leading-[1.2]'),
				attrs),
			children);
	});
var $author$project$UI$formFeedbackTextSmAttr = $author$project$TW$cls('mb-3 text-[0.9rem] leading-[1.4] text-[var(--fg-muted)]');
var $author$project$UI$hostAdminWikiSlugClass = '[font-family:var(--font-mono)] text-[0.95rem] text-[var(--fg-muted)] break-all';
var $author$project$UI$formTextInputHostAdminSlugClass = $author$project$UI$formTextInputClass + (' ' + ($author$project$UI$hostAdminWikiSlugClass + ' w-full max-w-full'));
var $author$project$UI$formTextInputHostAdminSlugAttr = $author$project$TW$cls($author$project$UI$formTextInputHostAdminSlugClass);
var $author$project$UI$hostAdminBackupCardAttr = $author$project$TW$cls('mb-8 max-w-3xl border border-[var(--border-subtle)] p-3');
var $author$project$UI$hostAdminCardParagraphTightAttr = $author$project$TW$cls('m-0 mb-1.5 text-[0.95rem] leading-[1.4] text-[var(--fg)]');
var $author$project$UI$hostAdminDangerBlurbAttr = $author$project$TW$cls('m-0 mb-2 text-[0.95rem] leading-[1.4] text-[var(--fg)]');
var $author$project$UI$hostAdminStatusParaAttr = $author$project$TW$cls('m-0 mb-1.5 text-[0.95rem] leading-[1.4] text-[var(--fg)]');
var $author$project$UI$hostAdminWikiDetailCardClass = 'border border-[var(--border-subtle)] bg-[var(--chrome-bg)] rounded-xl p-4 shadow-[0_4px_16px_rgba(73,103,49,0.07)]';
var $author$project$UI$hostAdminWikiDetailCardAttr = $author$project$TW$cls($author$project$UI$hostAdminWikiDetailCardClass);
var $author$project$UI$hostAdminWikiDetailDangerCardClass = 'border border-[var(--danger)] bg-[var(--danger-bg)] rounded-xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.06)]';
var $author$project$UI$hostAdminWikiDetailDangerCardAttr = $author$project$TW$cls($author$project$UI$hostAdminWikiDetailDangerCardClass);
var $author$project$UI$hostAdminWikiDetailFormStackAttr = $author$project$TW$cls('mt-1.5 flex flex-col gap-1 min-w-0');
var $author$project$UI$hostAdminWikiDetailGridClass = 'grid grid-cols-[minmax(0,1fr)_17rem] gap-5 items-start';
var $author$project$UI$hostAdminWikiDetailGridAttr = $author$project$TW$cls($author$project$UI$hostAdminWikiDetailGridClass);
var $author$project$UI$hostAdminWikiDetailMainStackClass = 'flex flex-col gap-3 min-w-0';
var $author$project$UI$hostAdminWikiDetailMainStackAttr = $author$project$TW$cls($author$project$UI$hostAdminWikiDetailMainStackClass);
var $author$project$UI$hostAdminWikiDetailPageTitleClass = 'm-0 text-[1.35rem] font-semibold leading-[1.2] text-[var(--fg)]';
var $author$project$UI$hostAdminWikiDetailPageTitleAttr = $author$project$TW$cls($author$project$UI$hostAdminWikiDetailPageTitleClass);
var $author$project$UI$hostAdminWikiDetailShellClass = 'w-full min-w-0';
var $author$project$UI$hostAdminWikiDetailShellAttr = $author$project$TW$cls($author$project$UI$hostAdminWikiDetailShellClass);
var $author$project$UI$hostAdminWikiDetailSideStackClass = 'flex flex-col gap-3 min-w-0';
var $author$project$UI$hostAdminWikiDetailSideStackAttr = $author$project$TW$cls($author$project$UI$hostAdminWikiDetailSideStackClass);
var $author$project$UI$tableCellClass = 'px-[0.55rem] py-[0.22rem] text-left align-top';
var $author$project$UI$tableCellMonoTimestampClass = $author$project$UI$tableCellClass + ' [font-family:var(--font-mono)] whitespace-nowrap text-[0.8125rem]';
var $author$project$UI$tableCellMonoTimestampAttr = $author$project$TW$cls($author$project$UI$tableCellMonoTimestampClass);
var $author$project$UI$tableCellMiddleClass = 'px-[0.55rem] py-[0.22rem] text-left align-middle';
var $author$project$UI$cellClassForVerticalAlign = function (align) {
	if (align.$ === 'TableAlignTop') {
		return $author$project$UI$tableCellClass;
	} else {
		return $author$project$UI$tableCellMiddleClass;
	}
};
var $elm$html$Html$td = _VirtualDom_node('td');
var $author$project$UI$tableTd = F3(
	function (align, extraAttrs, children) {
		return A2(
			$elm$html$Html$td,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls(
					$author$project$UI$cellClassForVerticalAlign(align)),
				extraAttrs),
			children);
	});
var $elm$html$Html$Attributes$value = $elm$html$Html$Attributes$stringProperty('value');
var $author$project$UI$StatusBadge$activeClass = 'inline-block text-[0.82rem] font-semibold tracking-wide uppercase px-[0.4rem] py-[0.12rem] border border-[var(--border)] bg-[var(--input-bg)] text-[var(--fg)]';
var $author$project$UI$StatusBadge$inactiveClass = 'inline-block text-[0.82rem] font-semibold tracking-wide uppercase px-[0.4rem] py-[0.12rem] border border-[var(--border-dash)] bg-[var(--bg)] text-[var(--fg-muted)]';
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$UI$StatusBadge$view = function (config) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
				$author$project$TW$cls(
				config.isActive ? $author$project$UI$StatusBadge$activeClass : $author$project$UI$StatusBadge$inactiveClass)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(config.text)
			]));
};
var $author$project$Chapters$Admin$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$hostAdminWikiDetailCardAttr]),
				_List_fromArray(
					[
						A2(
						$author$project$UI$Heading$cardHeadingSm,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Wiki Settings')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[$author$project$UI$hostAdminCardParagraphTightAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('Manage this wiki\'s configuration and access controls.')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$hostAdminWikiDetailFormStackAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$label,
								_List_fromArray(
									[
										$author$project$TW$cls('block text-[0.82rem] font-medium text-[var(--fg-muted)]')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$author$project$UI$formTextInputHostAdminSlugAttr,
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Attributes$value('my-wiki')
									]),
								_List_Nil),
								A2(
								$author$project$UI$Button$button,
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$hostAdminWikiDetailDangerCardAttr]),
				_List_fromArray(
					[
						A2(
						$author$project$UI$Heading$cardHeadingDanger,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Delete Wiki')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[$author$project$UI$hostAdminDangerBlurbAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('Permanently deletes the wiki and all its pages. This cannot be undone.')
							])),
						A2(
						$author$project$UI$Button$dangerButton,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Delete this wiki')
							]))
					]))),
			_Utils_Tuple2(
			'hostAdminWikiStatusBadge — active',
			$author$project$UI$StatusBadge$view(
				{isActive: true, text: 'Active'})),
			_Utils_Tuple2(
			'hostAdminWikiStatusBadge — inactive',
			$author$project$UI$StatusBadge$view(
				{isActive: false, text: 'Inactive'})),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$TW$cls($author$project$UI$hostAdminWikiSlugClass)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('my-elm-wiki-slug')
					]))),
			_Utils_Tuple2(
			'hostAdminBackupCard',
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$hostAdminBackupCardAttr]),
				_List_fromArray(
					[
						A2(
						$author$project$UI$Heading$cardHeadingLg,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Backups')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[$author$project$UI$formFeedbackTextSmAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('Download a full backup of all wiki content as JSON.')
							])),
						A2(
						$author$project$UI$Button$button,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Download backup')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$hostAdminWikiDetailShellAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$h1,
						_List_fromArray(
							[$author$project$UI$hostAdminWikiDetailPageTitleAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('Wiki: My Elm Wiki')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$hostAdminWikiDetailGridAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$hostAdminWikiDetailMainStackAttr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$div,
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$p,
												_List_fromArray(
													[$author$project$UI$hostAdminStatusParaAttr]),
												_List_fromArray(
													[
								...
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$hostAdminWikiDetailSideStackAttr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$div,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('my-elm-wiki')
													]))
											]))
									]))
							]))
			...
			$author$project$UI$auditLogTableView(
				{
					columnClasses: _List_fromArray(
						['w-[12rem]', 'w-[12rem]', '']),
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$td,
									_List_fromArray(
										[$author$project$UI$tableCellMonoTimestampAttr]),
									_List_fromArray(
										[
											$elm$html$Html$text('2024-01-01 10:30')
										])),
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignTop,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text('alice@example.com')
										])),
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignTop,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Created page: Getting Started')
										]))
								])),
							A2(
							$elm$html$Html$tr,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('2024-01-02 14:15')
										])),
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignTop,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('bob@example.com')
										])),
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignTop,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Edited page: Introduction')
										]))
								])),
							A2(
							$elm$html$Html$tr,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('2024-01-03 09:00')
										])),
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignTop,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('carol@example.com')
										])),
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignTop,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Deleted page: Draft')
										]))
								]))
						]),
					tableId: 'audit-demo',
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Admin Components'));
var $author$project$UI$appHeaderBarClass = 'shrink-0 flex flex-row flex-wrap items-center justify-between gap-y-[0.5rem] gap-x-[0.75rem] -mx-[0.5rem] px-[0.5rem] pt-[0.2rem] pb-[0.55rem] border-b border-[var(--border-subtle)] shadow-[0_4px_20px_rgba(73,103,49,0.08)] backdrop-blur-sm';
var $author$project$UI$appHeaderBarAttr = $author$project$TW$cls($author$project$UI$appHeaderBarClass);
var $author$project$UI$appHeaderDividerClass = 'self-stretch w-0 my-0 border-l-2 border-[var(--border)] min-h-[1.15em]';
var $author$project$UI$appHeaderDividerAttr = $author$project$TW$cls($author$project$UI$appHeaderDividerClass);
var $author$project$UI$appHeaderH1Class = 'm-0 text-[1.5rem] font-semibold leading-[1.2] text-[var(--fg)] flex-1 min-w-0 [font-family:var(--font-serif)]';
var $author$project$UI$appHeaderH1Attr = $author$project$TW$cls($author$project$UI$appHeaderH1Class);
var $author$project$UI$appHeaderPrimaryPlainClass = 'font-semibold';
var $author$project$UI$appHeaderPrimaryPlainAttr = $author$project$TW$cls($author$project$UI$appHeaderPrimaryPlainClass);
var $author$project$UI$appHeaderSecondaryAfterDividerClass = 'italic min-w-0';
var $author$project$UI$appHeaderSecondaryAfterDividerAttr = $author$project$TW$cls($author$project$UI$appHeaderSecondaryAfterDividerClass);
var $author$project$UI$appHeaderSecondaryBracketClass = 'not-italic text-[var(--fg-muted)] opacity-[0.42] font-normal text-[0.88em]';
var $author$project$UI$appHeaderSecondaryBracketAttr = $author$project$TW$cls($author$project$UI$appHeaderSecondaryBracketClass);
var $author$project$UI$appHeaderSecondaryMetaClass = 'text-[var(--fg-muted)] font-normal max-w-full';
var $author$project$UI$appHeaderSecondaryMetaAttr = $author$project$TW$cls($author$project$UI$appHeaderSecondaryMetaClass);
var $author$project$UI$appHeaderSecondaryWikiLabelEmClass = 'text-[var(--fg-muted)] font-normal';
var $author$project$UI$appHeaderSecondaryWikiLabelEmAttr = $author$project$TW$cls($author$project$UI$appHeaderSecondaryWikiLabelEmClass);
var $author$project$UI$appHeaderSecondaryWikiWrapClass = $author$project$UI$appHeaderSecondaryMetaClass + ' inline-flex items-baseline flex-wrap gap-x-[0.15rem] gap-y-[0.05rem]';
var $author$project$UI$appHeaderSecondaryWikiWrapAttr = $author$project$TW$cls($author$project$UI$appHeaderSecondaryWikiWrapClass);
var $author$project$UI$appHeaderTitleRowClass = 'inline-flex items-center flex-wrap gap-x-[0.65rem] gap-y-[0.35rem] max-w-full';
var $author$project$UI$appHeaderTitleRowAttr = $author$project$TW$cls($author$project$UI$appHeaderTitleRowClass);
...
var $author$project$UI$Button$iconGhostClass = 'shrink-0 inline-flex items-center justify-center w-[2.35rem] h-[2.35rem] p-0 m-0 border-0 bg-transparent text-[var(--fg)] cursor-pointer hover:bg-[var(--chrome-bg)]';
var $author$project$UI$Button$iconGhostButton = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$button,
			$author$project$UI$FocusVisible$on(
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls($author$project$UI$Button$iconGhostClass),
					attrs)),
			children);
	});
var $elm$html$Html$a = _VirtualDom_node('a');
var $author$project$UI$Link$navPrimaryClass = 'font-semibold text-[var(--fg)] hover:bg-[var(--link-bg-hover)] underline underline-offset-[2px]';
var $author$project$UI$Link$navPrimary = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$a,
			$author$project$UI$FocusVisible$on(
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls($author$project$UI$Link$navPrimaryClass),
					attrs)),
			children);
	});
var $author$project$Chapters$AppHeader$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[$author$project$UI$appHeaderBarAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$h1,
						_List_fromArray(
							[$author$project$UI$appHeaderH1Attr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$appHeaderTitleRowAttr]),
								_List_fromArray(
									[
										A2(
										$author$project$UI$Link$navPrimary,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('My Wiki')
											])),
										A2(
										$elm$html$Html$div,
										_List_fromArray(
											[$author$project$UI$appHeaderDividerAttr]),
										_List_Nil),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
											[$author$project$UI$appHeaderSecondaryWikiWrapAttr]),
										_List_fromArray(
											[
												A2(
												$elm$html$Html$span,
												_List_fromArray(
													[$author$project$UI$appHeaderSecondaryBracketAttr]),
												_List_fromArray(
													[
														$elm$html$Html$text('[')
													])),
												...
												$elm$html$Html$span,
												_List_fromArray(
													[$author$project$UI$appHeaderSecondaryAfterDividerAttr]),
												_List_fromArray(
													[
						...
						A2(
						$author$project$UI$Button$iconGhostButton,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('☀')
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$span,
								_List_fromArray(
									[$author$project$UI$appHeaderPrimaryPlainAttr]),
								_List_fromArray(
									[
										$elm$html$Html$text('Host Admin')
									]))
							]))
					]))),
			_Utils_Tuple2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$span,
										_List_fromArray(
											[$author$project$UI$appHeaderSecondaryMetaAttr]),
										_List_fromArray(
											[
												A2(
												$elm$html$Html$em,
												_List_fromArray(
													[$author$project$UI$appHeaderSecondaryWikiLabelEmAttr]),
												_List_fromArray(
													[
														$elm$html$Html$text('a wiki about ')
													])),
												$elm$html$Html$text('Functional Programming')
											]))
									]))
							])),
						A2(
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('App Header'));
var $author$project$UI$contentParagraph = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$p,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$contentParagraphClass),
				attrs),
			children);
	});
var $author$project$UI$EmptyState$status = function (cfg) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id(cfg.id),
				A2($elm$html$Html$Attributes$attribute, 'role', 'status')
			]),
		_List_fromArray(
			[
				A2(
				$author$project$UI$contentParagraph,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(cfg.text)
					]))
			]));
};
var $author$project$UI$AsyncState$empty = $author$project$UI$EmptyState$status;
var $author$project$UI$AsyncState$loading = function (message) {
	return A2(
		$author$project$UI$contentParagraph,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Chapters$AsyncState$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			'AsyncState.loading',
			$author$project$UI$AsyncState$loading('Loading...')),
			_Utils_Tuple2(
			'AsyncState.empty (= EmptyState.status)',
			$author$project$UI$AsyncState$empty(
				{id: 'book-async-empty', text: 'Nothing here yet.'}))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.AsyncState'));
var $author$project$Chapters$Button$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.Button'));
var $author$project$UI$EditorShell$containerClass = 'flex flex-col h-[calc(100dvh-11rem)] min-h-[32rem] border border-[var(--border-subtle)] rounded-2xl overflow-hidden bg-[var(--chrome-bg)] shadow-[0_12px_30px_rgba(73,103,49,0.08)]';
var $author$project$UI$EditorShell$contentGridClass = 'grid min-h-0 flex-1 grid-cols-2 divide-x divide-[var(--border-subtle)]';
var $author$project$UI$EditorShell$controlsRowClass = 'shrink-0 px-4 py-3 border-b border-[var(--border-subtle)] bg-[var(--bg)] flex flex-wrap gap-3 items-end';
var $author$project$UI$EditorShell$view = function (cfg) {
	return A2(
		$elm$html$Html$div,
		A2(
			$elm$core$List$cons,
			$author$project$TW$cls($author$project$UI$EditorShell$containerClass),
			cfg.containerAttrs),
		_List_fromArray(
			[
				A2(
				...
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls($author$project$UI$EditorShell$controlsRowClass),
					cfg.controlsAttrs),
				...
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls($author$project$UI$EditorShell$contentGridClass),
					cfg.contentAttrs),
				cfg.contentChildren)
			]));
};
var $author$project$Chapters$EditorShell$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$TW$cls('max-w-2xl space-y-2')
					]),
				_List_fromArray(
					[
						$author$project$UI$EditorShell$view(
						{
							containerAttrs: _List_fromArray(
								[
									$author$project$TW$cls('min-h-[8rem]')
								]),
							contentAttrs: _List_fromArray(
								[
									$author$project$TW$cls('min-h-[5rem]')
								]),
							contentChildren: _List_fromArray(
								[
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$author$project$TW$cls('p-2 bg-[var(--input-bg)] text-[0.75rem]')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('col a')
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$author$project$TW$cls('p-2 bg-[var(--bg)] text-[0.75rem]')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('col b')
										]))
								]),
							controlsAttrs: _List_fromArray(
								[
									$author$project$TW$cls('p-2 text-[0.8rem]')
								]),
							controlsChildren: _List_fromArray(
								[
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.EditorShell'));
var $author$project$UI$EmptyState$paragraph = function (cfg) {
	return A2(
		$author$project$UI$contentParagraph,
		_List_fromArray(
			[
...
var $author$project$Chapters$EmptyState$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			'EmptyState.paragraph',
			$author$project$UI$EmptyState$paragraph(
				{id: 'book-empty-paragraph', text: 'No rows in this list.'}))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.EmptyState'));
var $author$project$Chapters$FocusVisible$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				$author$project$UI$FocusVisible$on(
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('#'),
							$author$project$TW$cls('text-[var(--link)] underline')
						])),
				_List_fromArray(
					[
						$elm$html$Html$text('focus-visible ring')
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.FocusVisible'));
var $author$project$UI$FormActionFooter$AlignBetween = {$: 'AlignBetween'};
var $author$project$UI$FormActionFooter$AlignEnd = {$: 'AlignEnd'};
var $author$project$UI$SubmissionActions$primaryPairButtons = function (cfg) {
	return _List_fromArray(
		[
			A2(
			$author$project$UI$Button$button,
			...
			_List_fromArray(
				[
					$elm$html$Html$text(cfg.submitLabel)
				]))
		]);
};
var $author$project$UI$SubmissionActions$primaryPairRow = function (cfg) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		$author$project$UI$SubmissionActions$primaryPairButtons(cfg));
};
var $elm$html$Html$footer = _VirtualDom_node('footer');
var $author$project$UI$FormActionFooter$stickyBaseClass = 'shrink-0 sticky bottom-0 z-10 border-t border-[var(--border-subtle)] bg-[var(--bg)] px-4 py-3 flex';
var $author$project$UI$FormActionFooter$sticky = function (cfg) {
	var rowClass = function () {
		var _v1 = cfg.align;
		if (_v1.$ === 'AlignEnd') {
			return $author$project$UI$FormActionFooter$stickyBaseClass + ' justify-end gap-2';
		} else {
			return $author$project$UI$FormActionFooter$stickyBaseClass + ' justify-between items-center gap-2';
		}
	}();
	var children = function () {
		...
		if (_v0.$ === 'AlignEnd') {
			...
			return _Utils_ap(cfg.left, cfg.right);
		}
	}();
	return A2(
...
var $author$project$Chapters$FormActionFooter$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$TW$cls('relative flex h-36 flex-col overflow-hidden rounded-lg border border-dashed border-[var(--border-subtle)]')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$author$project$TW$cls('min-h-0 flex-1 p-2 text-[0.85rem] text-[var(--fg-muted)]')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Form body; footer sticks to bottom of this box.')
							])),
						$author$project$UI$FormActionFooter$sticky(
						{
							align: $author$project$UI$FormActionFooter$AlignEnd,
							left: _List_Nil,
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Disclaimer + actions (submit-edit pattern).')
							])),
						$author$project$UI$FormActionFooter$sticky(
						{
							align: $author$project$UI$FormActionFooter$AlignBetween,
							left: _List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$TW$cls('m-0 max-w-[14rem] text-[0.84rem] text-[var(--fg-muted)]')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Reviewer must approve before changes go live.')
										]))
								]),
							right: _List_fromArray(
								[
									$author$project$UI$SubmissionActions$primaryPairRow(
									{saveDraftAttrs: _List_Nil, submitAttrs: _List_Nil, submitLabel: 'Submit for review'})
								])
						})
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.FormActionFooter'));
var $author$project$UI$contentLabelClass = 'block mt-[0.25rem] text-[0.8125rem] text-[var(--fg-muted)] [font-family:var(--font-ui)]';
var $author$project$UI$contentLabel = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$label,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$contentLabelClass),
				attrs),
			children);
	});
var $elm$html$Html$Attributes$disabled = $elm$html$Html$Attributes$boolProperty('disabled');
var $author$project$UI$formCenteredCardClass = 'mx-auto mt-[3rem] mb-[3rem] max-w-[28rem] border border-[var(--border-subtle)] bg-[var(--auth-card-bg)] text-[var(--auth-card-fg)] rounded-2xl p-8 shadow-[0_8px_40px_rgba(0,0,0,0.2)]';
var $author$project$UI$formCenteredCardAttr = $author$project$TW$cls($author$project$UI$formCenteredCardClass);
var $author$project$UI$formTextInputAttr = $author$project$TW$cls($author$project$UI$formTextInputClass);
var $author$project$Chapters$FormControls$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$formTextInputAttr,
						$elm$html$Html$Attributes$type_('text'),
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$formTextInputHostAdminSlugAttr,
						$elm$html$Html$Attributes$type_('text'),
						$elm$html$Html$Attributes$placeholder('my-wiki-slug')
					]),
				_List_Nil)),
			_Utils_Tuple2(
			'button (primary)',
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Delete page')
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$formCenteredCardAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$author$project$TW$cls('m-0 mb-3 font-semibold text-[1.1rem] text-[var(--fg)]')
							]),
						_List_fromArray(
							[
						...
						A2(
						$author$project$UI$contentLabel,
						_List_Nil,
						_List_fromArray(
							[
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Form Controls'));
var $author$project$GraphData$Directed = {$: 'Directed'};
var $author$project$Chapters$Graph$LinkEdge = {$: 'LinkEdge'};
var $author$project$Chapters$Graph$TagEdge = {$: 'TagEdge'};
var $author$project$UI$Graph$LinkEdge = {$: 'LinkEdge'};
var $author$project$UI$Graph$TagEdge = {$: 'TagEdge'};
var $author$project$UI$Graph$Directed = {$: 'Directed'};
var $author$project$UI$Graph$Undirected = {$: 'Undirected'};
var $author$project$Chapters$Graph$toUiDirection = function (direction) {
	if (direction.$ === 'Directed') {
		return $author$project$UI$Graph$Directed;
	} else {
		return $author$project$UI$Graph$Undirected;
	}
};
var $author$project$Chapters$Graph$edgeToUi = function (exampleEdge) {
	return {
		direction: $author$project$Chapters$Graph$toUiDirection(exampleEdge.direction),
		from: exampleEdge.fromSlug,
		kind: function () {
			var _v0 = exampleEdge.kind;
			if (_v0.$ === 'LinkEdge') {
				return $author$project$UI$Graph$LinkEdge;
			} else {
				return $author$project$UI$Graph$TagEdge;
			}
		}(),
		to: exampleEdge.toSlug
	};
};
var $author$project$UI$Graph$MissingNode = {$: 'MissingNode'};
var $author$project$UI$Graph$NormalNode = {$: 'NormalNode'};
var $author$project$Chapters$Graph$node = F4(
	function (id, href, inboundCount, isMissing) {
		return {
			href: href,
			id: id,
			inboundCount: inboundCount,
			kind: isMissing ? $author$project$UI$Graph$MissingNode : $author$project$UI$Graph$NormalNode
		};
	});
var $author$project$GraphData$Undirected = {$: 'Undirected'};
var $author$project$Chapters$Graph$edgeKindSortKey = function (kind) {
	if (kind.$ === 'LinkEdge') {
		return '0';
	} else {
		return '1';
...
var $author$project$Chapters$Graph$edgeToString = function (edge) {
	return edge.fromSlug + (' -> ' + (edge.toSlug + (' (' + (function () {
		var _v0 = edge.kind;
		if (_v0.$ === 'LinkEdge') {
			return 'link';
		} else {
...
var $author$project$GraphData$slugSortKey = function (pageSlug) {
	return $elm$core$String$toLower(pageSlug) + ('|' + pageSlug);
};
var $author$project$GraphData$canonicalPair = F2(
	function (left, right) {
		return (_Utils_cmp(
			$author$project$GraphData$slugSortKey(left),
			$author$project$GraphData$slugSortKey(right)) < 1) ? _Utils_Tuple2(left, right) : _Utils_Tuple2(right, left);
	});
var $author$project$GraphData$directionSortKey = function (direction) {
	if (direction.$ === 'Directed') {
		return '0';
	} else {
		return '1';
...
var $author$project$GraphData$normalizeEdges = F2(
	function (config, rawEdges) {
		var undirectedEdgeKey = function (edge) {
			var _v2 = A2(
				$author$project$GraphData$canonicalPair,
				config.fromSlug(edge),
				config.toSlug(edge));
			var canonicalFrom = _v2.a;
			var canonicalTo = _v2.b;
			return config.kindSortKey(edge) + ('|' + ($author$project$GraphData$slugSortKey(canonicalFrom) + ('|' + $author$project$GraphData$slugSortKey(canonicalTo))));
		};
		var reverseDirectedEdgeKey = function (edge) {
			return config.kindSortKey(edge) + ('|' + ($author$project$GraphData$slugSortKey(
				config.toSlug(edge)) + ('|' + $author$project$GraphData$slugSortKey(
				config.fromSlug(edge)))));
		};
		var edgeSortKey = function (edge) {
			return config.kindSortKey(edge) + ('|' + ($author$project$GraphData$slugSortKey(
				config.fromSlug(edge)) + ('|' + ($author$project$GraphData$slugSortKey(
				config.toSlug(edge)) + ('|' + $author$project$GraphData$directionSortKey(
				config.direction(edge)))))));
		};
		var directedEdgeKey = function (edge) {
			return config.kindSortKey(edge) + ('|' + ($author$project$GraphData$slugSortKey(
				config.fromSlug(edge)) + ('|' + $author$project$GraphData$slugSortKey(
				config.toSlug(edge)))));
		};
		var rawLookup = A3(
			...
			$elm$core$Dict$empty,
			A2($elm$core$List$sortBy, edgeSortKey, rawEdges));
		var normalizedLookup = A3(
			$elm$core$List$foldl,
			F2(
				function (edge, acc) {
					var normalizedEdge = function () {
						if ((!_Utils_eq(
							config.fromSlug(edge),
							config.toSlug(edge))) && A2(
							...
							var _v1 = A2(
								...
								config.fromSlug(edge),
								config.toSlug(edge));
							var canonicalFrom = _v1.a;
							var canonicalTo = _v1.b;
							return A2(
								config.toUndirected,
								{canonicalFrom: canonicalFrom, canonicalTo: canonicalTo},
								edge);
						} else {
							return edge;
						}
					}();
					var normalizedKey = function () {
						var _v0 = config.direction(normalizedEdge);
						if (_v0.$ === 'Directed') {
							return directedEdgeKey(normalizedEdge);
						} else {
							return undirectedEdgeKey(normalizedEdge);
						}
					}();
					return A3($elm$core$Dict$insert, normalizedKey, normalizedEdge, acc);
				}),
			$elm$core$Dict$empty,
			A2(
				$elm$core$List$sortBy,
				edgeSortKey,
				$elm$core$Dict$values(rawLookup)));
		return A2(
			$elm$core$List$sortBy,
			edgeSortKey,
			$elm$core$Dict$values(normalizedLookup));
	});
var $author$project$Chapters$Graph$normalizedEdgesPreview = A2(
	$elm$core$String$join,
	'\n',
	A2(
		$elm$core$List$map,
		$author$project$Chapters$Graph$edgeToString,
		A2(
			$author$project$GraphData$normalizeEdges,
			{
				direction: function ($) {
					return $.direction;
				},
				...
				kindSortKey: A2(
					...
					$author$project$Chapters$Graph$edgeKindSortKey),
				toSlug: function ($) {
					return $.toSlug;
				},
				toUndirected: F2(
					function (pair, normalizedEdge) {
						return _Utils_update(
							normalizedEdge,
							{direction: $author$project$GraphData$Undirected, fromSlug: pair.canonicalFrom, toSlug: pair.canonicalTo});
					})
			},
			_List_fromArray(
				[
					{direction: $author$project$GraphData$Directed, fromSlug: 'Alpha', kind: $author$project$Chapters$Graph$LinkEdge, toSlug: 'Beta'},
					{direction: $author$project$GraphData$Directed, fromSlug: 'Beta', kind: $author$project$Chapters$Graph$LinkEdge, toSlug: 'Alpha'},
					{direction: $author$project$GraphData$Directed, fromSlug: 'Alpha', kind: $author$project$Chapters$Graph$TagEdge, toSlug: 'Tag'}
				]))));
...
var $author$project$UI$Graph$dotString = function (raw) {
	return '\"' + (A3(
		...
		A3(
			...
			'\"',
			'\\\"',
			A3($elm$core$String$replace, '\\', '\\\\', raw))) + '\"');
};
var $author$project$UI$Graph$edgeAttrs = function (edge) {
	var directionAttrs = function () {
		var _v1 = edge.direction;
		if (_v1.$ === 'Directed') {
			return _List_Nil;
		} else {
	...
	if (_v0.$ === 'LinkEdge') {
		...
		return _Utils_ap(
			_List_fromArray(
				[
					'style=' + $author$project$UI$Graph$dotString('dashed'),
					'color=' + $author$project$UI$Graph$dotString('#7c3aed')
				]),
			directionAttrs);
	}
};
...
var $author$project$UI$Graph$edgeLine = function (edge) {
	var attrs = $author$project$UI$Graph$edgeAttrs(edge);
	var attrsPart = $elm$core$List$isEmpty(attrs) ? ';' : (' [' + (A2($elm$core$String$join, ', ', attrs) + '];'));
	return '  ' + ($author$project$UI$Graph$dotString(edge.from) + (' -> ' + ($author$project$UI$Graph$dotString(edge.to) + attrsPart)));
};
var $elm$core$String$fromFloat = _String_fromNumber;
var $elm$core$Basics$round = _Basics_round;
var $author$project$UI$Graph$formatFloat = function (value) {
	return $elm$core$String$fromFloat(
		function (v) {
			return $elm$core$Basics$round(v * 100) / 100;
		}(value));
};
var $author$project$UI$Graph$missingNodeAttrs = _List_fromArray(
	[
		'style=' + $author$project$UI$Graph$dotString('dashed'),
		'color=' + $author$project$UI$Graph$dotString('#dc2626'),
		'fontcolor=' + $author$project$UI$Graph$dotString('#dc2626')
	]);
var $elm$core$Basics$clamp = F3(
	function (low, high, number) {
		return (_Utils_cmp(number, low) < 0) ? low : ((_Utils_cmp(number, high) > 0) ? high : number);
	});
var $author$project$UI$Graph$inboundScale = function (inboundCount) {
	return A3(
		$elm$core$Basics$clamp,
		0,
		1,
		A2($elm$core$Basics$logBase, 11, inboundCount + 1));
};
var $author$project$UI$Graph$nodeFontSize = function (inboundCount) {
	return 9 + (13 * $author$project$UI$Graph$inboundScale(inboundCount));
};
var $author$project$UI$Graph$nodeHeight = function (inboundCount) {
	return 0.3 + (0.45 * $author$project$UI$Graph$inboundScale(inboundCount));
};
var $author$project$UI$Graph$nodePenWidth = function (inboundCount) {
	return 1 + (0.9 * $author$project$UI$Graph$inboundScale(inboundCount));
};
var $author$project$UI$Graph$nodeLine = function (node) {
	var basePenWidth = $author$project$UI$Graph$nodePenWidth(node.inboundCount);
	var penWidth = function () {
		var _v1 = node.kind;
		switch (_v1.$) {
			case 'FocusedNode':
				return A2($elm$core$Basics$max, 2, basePenWidth);
			case 'MissingFocusedNode':
				return A2($elm$core$Basics$max, 2, basePenWidth);
			case 'NormalNode':
				return basePenWidth;
			default:
	...
	var attrs = _Utils_ap(
		_List_fromArray(
			[
				'href=' + $author$project$UI$Graph$dotString(node.href),
				'height=' + $author$project$UI$Graph$formatFloat(
				$author$project$UI$Graph$nodeHeight(node.inboundCount)),
				'fontsize=' + $author$project$UI$Graph$formatFloat(
				$author$project$UI$Graph$nodeFontSize(node.inboundCount)),
				'penwidth=' + $author$project$UI$Graph$formatFloat(penWidth)
			]),
		function () {
			var _v0 = node.kind;
			switch (_v0.$) {
				case 'MissingNode':
					return $author$project$UI$Graph$missingNodeAttrs;
				case 'MissingFocusedNode':
					return $author$project$UI$Graph$missingNodeAttrs;
				case 'NormalNode':
					return _List_Nil;
	...
	return '  ' + ($author$project$UI$Graph$dotString(node.id) + (' [' + (A2($elm$core$String$join, ', ', attrs) + '];')));
};
...
var $author$project$UI$Graph$defaultEdgeAttrsLine = '  edge [color=' + ($author$project$UI$Graph$dotString('#6b7280') + (', arrowsize=0.7' + (', penwidth=0.9' + (', len=0.9' + '];'))));
var $author$project$UI$Graph$defaultGraphAttrsLines = _List_fromArray(
	[
		'  layout=neato;',
		'  overlap=' + ($author$project$UI$Graph$dotString('prism') + ';'),
		'  overlap_scaling=1;',
		'  sep=' + ($author$project$UI$Graph$dotString('+6') + ';'),
		'  esep=' + ($author$project$UI$Graph$dotString('+2') + ';'),
		'  splines=true;',
		'  mode=major;',
		'  model=' + ($author$project$UI$Graph$dotString('shortpath') + ';'),
		'  start=' + ($author$project$UI$Graph$dotString('random42') + ';'),
		'  epsilon=0.0001;',
		'  maxiter=2000;',
		'  pad=' + ($author$project$UI$Graph$dotString('0.2') + ';'),
		'  concentrate=true;',
		'  bgcolor=' + ($author$project$UI$Graph$dotString('transparent') + ';')
	]);
var $author$project$UI$Graph$defaultNodeAttrsLine = '  node [shape=box' + (', fontname=' + ($author$project$UI$Graph$dotString('\'Source Serif 4\', system-ui, sans-serif') + (', fontsize=' + ($author$project$UI$Graph$dotString('11') + (', margin=' + ($author$project$UI$Graph$dotString('0.18,0.08') + (', height=0.3' + (', penwidth=1' + '];'))))))));
var $author$project$UI$Graph$renderDot = function (config) {
	return A2(
		$elm$core$String$join,
		'\n',
		$elm$core$List$concat(
			_List_fromArray(
				[
					...
					$author$project$UI$Graph$defaultGraphAttrsLines,
					_List_fromArray(
					[$author$project$UI$Graph$defaultNodeAttrsLine, $author$project$UI$Graph$defaultEdgeAttrsLine]),
					config.nodeLines,
					config.edgeLines,
					_List_fromArray(
					['}'])
...
var $author$project$UI$Graph$toDot = function (graph) {
	return $author$project$UI$Graph$renderDot(
		{
			edgeLines: A2($elm$core$List$map, $author$project$UI$Graph$edgeLine, graph.edges),
			graphName: graph.graphName,
			nodeLines: A2($elm$core$List$map, $author$project$UI$Graph$nodeLine, graph.nodes)
		});
};
var $author$project$UI$Graph$view = function (config) {
	return A3(
		$elm$html$Html$node,
		'graphviz-graph',
		_Utils_ap(
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$attribute,
					'graph',
					$author$project$UI$Graph$toDot(config.graph))
				]),
			config.attrs),
		_List_Nil);
};
var $author$project$Chapters$Graph$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'min-height', '24rem'),
						A2($elm$html$Html$Attributes$style, 'padding', '0.5rem')
					]),
				_List_fromArray(
					[
						$author$project$UI$Graph$view(
						{
							attrs: _List_Nil,
							graph: {
								edges: _List_fromArray(
									[
										$author$project$Chapters$Graph$edgeToUi(
										{direction: $author$project$GraphData$Directed, fromSlug: 'Alpha', kind: $author$project$Chapters$Graph$LinkEdge, toSlug: 'Beta'}),
										$author$project$Chapters$Graph$edgeToUi(
										{direction: $author$project$GraphData$Directed, fromSlug: 'Alpha', kind: $author$project$Chapters$Graph$TagEdge, toSlug: 'Missing Node'})
									]),
								graphName: 'book_graph',
								nodes: _List_fromArray(
									[
										A4($author$project$Chapters$Graph$node, 'Alpha', '/alpha', 8, false),
										A4($author$project$Chapters$Graph$node, 'Beta', '/beta', 2, false),
										A4($author$project$Chapters$Graph$node, 'Missing Node', '/missing', 1, true)
									])
							},
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$Chapters$Graph$normalizedEdgesPreview)
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.Graph'));
var $author$project$UI$Heading$contentHeading2Class = '[font-family:var(--font-serif)] mt-[0.5rem] mb-[0.25rem] font-semibold leading-[1.3] text-[1.25rem]';
var $author$project$UI$Heading$contentHeading2 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h2,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$contentHeading2Class),
				attrs),
			children);
	});
var $author$project$UI$Heading$markdownHeading2Class = 'mt-[1.25rem] mb-[0.4rem] font-semibold leading-[1.3] ' + ($author$project$UI$Heading$sidebarSubheadingTrackingClass + ' text-[var(--fg)] text-[2rem]');
var $author$project$UI$Heading$markdownHeading2 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h2,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$markdownHeading2Class),
				attrs),
			children);
	});
var $author$project$Chapters$Heading$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				$author$project$UI$Heading$contentHeading2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Heading module')
					]))),
			_Utils_Tuple2(
			'UI.Heading.markdownHeading2',
			A2(
				$author$project$UI$Heading$markdownHeading2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Markdown-sized heading')
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.Heading'));
var $elm$html$Html$Attributes$for = $elm$html$Html$Attributes$stringProperty('htmlFor');
var $author$project$UI$IconInput$view = function (cfg) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('absolute left-3 top-1/2 -translate-y-1/2 text-[var(--fg-muted)]'),
				...
				A2(
					$elm$core$List$cons,
					$elm$html$Html$Attributes$class('w-full pl-9'),
					cfg.attrs),
				_List_Nil)
			]));
};
var $author$project$Chapters$IconInput$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$TW$cls('max-w-xs space-y-3')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for('book-icon-user')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Username')
							])),
						$author$project$UI$IconInput$view(
						{
							attrs: _List_fromArray(
								[
									$elm$html$Html$Attributes$id('book-icon-user'),
									$elm$html$Html$Attributes$type_('text'),
									$elm$html$Html$Attributes$value('reader'),
									$elm$html$Html$Attributes$class('opacity-80'),
									$author$project$UI$formTextInputAttr
								]),
							icon: A2(
								$elm$html$Html$span,
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for('book-icon-pass')
							]),
						_List_fromArray(
							[
						...
						$author$project$UI$IconInput$view(
						{
							attrs: _List_fromArray(
								[
									$elm$html$Html$Attributes$id('book-icon-pass'),
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.IconInput'));
var $author$project$UI$Link$contentLinkClass = '[font-family:var(--font-serif)] text-[var(--link)] hover:text-[var(--link-hover)] hover:bg-[var(--link-bg-hover)] underline underline-offset-[2px]';
var $author$project$UI$Link$contentLink = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$a,
			$author$project$UI$FocusVisible$on(
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls($author$project$UI$Link$contentLinkClass),
					attrs)),
			children);
	});
var $author$project$Chapters$Link$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			'UI.Link.contentLink',
			A2(
				$author$project$UI$Link$contentLink,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('#')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Link module')
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.Link'));
var $elm$html$Html$blockquote = _VirtualDom_node('blockquote');
var $elm$html$Html$code = _VirtualDom_node('code');
var $elm$html$Html$hr = _VirtualDom_node('hr');
var $elm$html$Html$li = _VirtualDom_node('li');
var $author$project$UI$markdownBlockQuoteClass = 'my-[0.8rem] px-[0.75rem] py-[0.5rem] bg-[var(--chrome-bg)] border border-[var(--border-subtle)] rounded-lg italic text-[var(--fg-muted)] [font-family:var(--font-serif)]';
var $author$project$UI$markdownBlockQuoteAttr = $author$project$TW$cls($author$project$UI$markdownBlockQuoteClass);
var $author$project$UI$markdownCodeBlockCodeClass = '[font-family:var(--font-mono)] border-0 p-0 bg-transparent';
var $author$project$UI$markdownCodeBlockCodeAttr = $author$project$TW$cls($author$project$UI$markdownCodeBlockCodeClass);
var $author$project$UI$markdownCodeBlockPreClass = '[font-family:var(--font-mono)] my-[0.35rem] px-[0.45rem] py-[0.35rem] overflow-x-auto bg-[var(--code-bg)] border border-[var(--border)] text-[0.85rem] leading-[1.4]';
var $author$project$UI$markdownCodeBlockPreAttr = $author$project$TW$cls($author$project$UI$markdownCodeBlockPreClass);
var $author$project$UI$markdownCodeSpanClass = '[font-family:var(--font-mono)] text-[0.88em] bg-[var(--code-bg)] px-[0.2rem] py-[0.05rem]';
var $author$project$UI$markdownCodeSpanAttr = $author$project$TW$cls($author$project$UI$markdownCodeSpanClass);
var $author$project$UI$markdownContainerAttr = $author$project$TW$cls($author$project$UI$markdownContainerClass);
var $author$project$UI$Heading$markdownHeading3Class = 'mt-[1rem] mb-[0.35rem] font-semibold leading-[1.35] ' + ($author$project$UI$Heading$sidebarSubheadingTrackingClass + ' text-[var(--fg)] text-[1.5rem]');
var $author$project$UI$Heading$markdownHeading3 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h3,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$markdownHeading3Class),
				attrs),
			children);
	});
var $elm$html$Html$h4 = _VirtualDom_node('h4');
var $author$project$UI$Heading$markdownHeading4Class = 'mt-[0.75rem] mb-[0.25rem] font-semibold leading-[1.35] ' + ($author$project$UI$Heading$sidebarSubheadingTrackingClass + ' text-[var(--fg)] text-[1.25rem]');
var $author$project$UI$Heading$markdownHeading4 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h4,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$markdownHeading4Class),
				attrs),
			children);
	});
var $elm$html$Html$h5 = _VirtualDom_node('h5');
var $author$project$UI$Heading$markdownHeading5Class = 'mt-[0.75rem] mb-[0.25rem] font-semibold leading-[1.35] ' + ($author$project$UI$Heading$sidebarSubheadingTrackingClass + ' text-[var(--fg)] text-[1.125rem]');
var $author$project$UI$Heading$markdownHeading5 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h5,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$markdownHeading5Class),
				attrs),
			children);
	});
var $elm$html$Html$h6 = _VirtualDom_node('h6');
var $author$project$UI$Heading$markdownHeading6Class = 'mt-[0.75rem] mb-[0.25rem] font-semibold leading-[1.35] ' + ($author$project$UI$Heading$sidebarSubheadingTrackingClass + ' text-[var(--fg)] text-[1.0625rem]');
var $author$project$UI$Heading$markdownHeading6 = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$h6,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Heading$markdownHeading6Class),
				attrs),
			children);
	});
var $author$project$UI$markdownListItemClass = 'my-[0.1rem] [font-family:var(--font-serif)]';
var $author$project$UI$markdownListItemAttr = $author$project$TW$cls($author$project$UI$markdownListItemClass);
var $author$project$UI$markdownOrderedListClass = 'my-[0.25rem] pl-[1.35rem] list-decimal [font-family:var(--font-serif)]';
var $author$project$UI$markdownOrderedListAttr = $author$project$TW$cls($author$project$UI$markdownOrderedListClass);
var $author$project$UI$markdownParagraphAttr = $author$project$TW$cls($author$project$UI$markdownParagraphClass);
var $author$project$UI$tableBaseClass = 'border-collapse text-[0.94rem] leading-[1.35] border-t border-b border-[var(--border)] [&_th+th]:border-l [&_th+th]:border-[var(--border-dash)] [&_td+td]:border-l [&_td+td]:border-[var(--border-dash)] [&_tbody_tr:hover]:bg-[var(--table-row-hover)]';
var $author$project$UI$markdownTableClass = 'my-[0.8rem] mb-[1rem] max-w-full w-auto ' + $author$project$UI$tableBaseClass;
var $author$project$UI$markdownTableAttr = $author$project$TW$cls($author$project$UI$markdownTableClass);
var $author$project$UI$markdownTableCellClass = $author$project$UI$tableCellClass;
var $author$project$UI$markdownTableCellAttr = $author$project$TW$cls($author$project$UI$markdownTableCellClass);
var $author$project$UI$tableHeaderCellClass = 'px-[0.55rem] py-[0.22rem] text-left align-top bg-[var(--chrome-bg)] font-semibold border-b border-[var(--border)]';
var $author$project$UI$markdownTableHeaderCellClass = $author$project$UI$tableHeaderCellClass;
var $author$project$UI$markdownTableHeaderCellAttr = $author$project$TW$cls($author$project$UI$markdownTableHeaderCellClass);
var $author$project$UI$tableStripedRowClass = 'even:bg-[var(--table-stripe)]';
var $author$project$UI$markdownTableRowClass = $author$project$UI$tableStripedRowClass;
var $author$project$UI$markdownTableRowAttr = $author$project$TW$cls($author$project$UI$markdownTableRowClass);
var $author$project$UI$markdownThematicBreakClass = 'my-[0.35rem] border-0 border-t border-[var(--border)]';
var $author$project$UI$markdownThematicBreakAttr = $author$project$TW$cls($author$project$UI$markdownThematicBreakClass);
var $author$project$UI$markdownTodoClass = 'italic text-red-700 dark:text-red-400';
var $author$project$UI$markdownTodoAttr = $author$project$TW$cls($author$project$UI$markdownTodoClass);
var $author$project$UI$markdownUnorderedListClass = 'my-[0.25rem] pl-[1.35rem] list-disc [font-family:var(--font-serif)]';
var $author$project$UI$markdownUnorderedListAttr = $author$project$TW$cls($author$project$UI$markdownUnorderedListClass);
var $author$project$UI$Link$missingClass = '!text-red-700 dark:!text-red-400 hover:!bg-[var(--danger-link-bg-hover)] underline underline-offset-[2px]';
var $author$project$UI$Link$missingLink = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$a,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Link$missingClass),
				attrs),
			children);
	});
...
var $author$project$Chapters$MarkdownElements$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$markdownContainerAttr]),
				_List_fromArray(
					[
						A2(
						$author$project$UI$Heading$markdownHeading1,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Heading 2')
							])),
						A2(
						$author$project$UI$Heading$markdownHeading3,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Heading 3')
							])),
						A2(
						$author$project$UI$Heading$markdownHeading4,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Heading 4')
							])),
						A2(
						$author$project$UI$Heading$markdownHeading5,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Heading 5')
							])),
						A2(
						$author$project$UI$Heading$markdownHeading6,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Heading 6')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$p,
				_List_fromArray(
					[$author$project$UI$markdownParagraphAttr]),
				_List_fromArray(
					[
						$elm$html$Html$text('A paragraph of body text. It uses a serif typeface and comfortable line-height, reading naturally at medium column widths.')
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$ul,
				_List_fromArray(
					[$author$project$UI$markdownUnorderedListAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$li,
						_List_fromArray(
							[$author$project$UI$markdownListItemAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('First item')
							])),
						A2(
						$elm$html$Html$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Second item')
							])),
						A2(
						$elm$html$Html$li,
						_List_fromArray(
			...
			A2(
				$elm$html$Html$ol,
				_List_fromArray(
					[$author$project$UI$markdownOrderedListAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$li,
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$code,
						_List_fromArray(
							[$author$project$UI$markdownCodeSpanAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('elm make src/Main.elm')
							])),
						$elm$html$Html$text(' to compile.')
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$pre,
				_List_fromArray(
					[$author$project$UI$markdownCodeBlockPreAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$code,
						_List_fromArray(
							[$author$project$UI$markdownCodeBlockCodeAttr]),
						_List_fromArray(
							[
			...
			A2(
				$elm$html$Html$textarea,
				$author$project$UI$Textarea$markdownEditableCell(
					_List_fromArray(
						[
			...
			A2(
				...
				_List_fromArray(
					[$author$project$UI$markdownBlockQuoteAttr]),
				_List_fromArray(
					[
						$elm$html$Html$text('This is a blockquote with a left border and muted text color.')
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Content above the break.')
							])),
						A2(
						$elm$html$Html$hr,
						_List_fromArray(
							[$author$project$UI$markdownThematicBreakAttr]),
						_List_Nil),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Content below the break.')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('An in-document wiki link')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						A2(
						$author$project$UI$Link$missingLink,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('#')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('[[Missing Page]]')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$classAttr('grid grid-cols-2 gap-2')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$author$project$UI$classAttr('col-start-1 row-start-1'),
								$elm$html$Html$Attributes$href('#')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('[[Missing col 1]]')
							])),
						A2(
						$author$project$UI$Link$missingLink,
						_List_fromArray(
							[
								$author$project$UI$classAttr('col-start-2 row-start-1'),
								$elm$html$Html$Attributes$href('#')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('[[Missing col 2]]')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$p,
				_List_fromArray(
					[$author$project$UI$markdownTodoAttr]),
				_List_fromArray(
					[
						$elm$html$Html$text('TODO: finish this section')
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$table,
				_List_fromArray(
					[$author$project$UI$markdownTableAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$thead,
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$tr,
								_List_fromArray(
									[$author$project$UI$markdownTableRowAttr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$th,
										_List_fromArray(
											[$author$project$UI$markdownTableHeaderCellAttr]),
										_List_fromArray(
											[
												$elm$html$Html$text('Column A')
											])),
										A2(
										$elm$html$Html$th,
										_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$td,
										_List_fromArray(
											[$author$project$UI$markdownTableCellAttr]),
										_List_fromArray(
											[
												$elm$html$Html$text('Row 1, A')
											])),
										A2(
										$elm$html$Html$td,
										_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('This container has a max-height and overflow-y scroll.')
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('More content follows below.')
									]))
							]))
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Markdown Elements'));
var $elm$html$Html$aside = _VirtualDom_node('aside');
var $author$project$UI$Button$inlineLinkButton = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$button,
			$author$project$UI$FocusVisible$on(
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls('text-left bg-transparent border-0 p-0 [font-family:inherit] cursor-pointer ' + 'text-[var(--link)] hover:text-[var(--link-hover)] hover:bg-[var(--link-bg-hover)] underline underline-offset-[2px]'),
					attrs)),
			children);
	});
var $author$project$UI$layoutLeftNavAsideClass = 'self-stretch min-h-0 overflow-y-auto overscroll-contain leading-[1.35] text-[var(--fg)] text-[0.8125rem] border-r border-[var(--border-subtle)] py-[0.85rem] pr-[0.85rem] pl-0';
var $author$project$UI$layoutLeftNavAsideAttr = $author$project$TW$cls($author$project$UI$layoutLeftNavAsideClass);
var $elm$html$Html$nav = _VirtualDom_node('nav');
var $author$project$UI$Link$navListItemClass = function (emphasized) {
	return 'block w-full rounded py-[0.28rem] px-[0.55rem] -ml-[0.55rem] no-underline text-[var(--link)] hover:text-[var(--link-hover)] hover:bg-[var(--link-bg-hover)]' + (emphasized ? ' font-bold' : '');
};
var $author$project$UI$Link$navListItem = F3(
	function (emphasized, attrs, children) {
		return A2(
			$elm$html$Html$a,
			$author$project$UI$FocusVisible$on(
				A2(
					$elm$core$List$cons,
					$author$project$TW$cls(
						$author$project$UI$Link$navListItemClass(emphasized)),
					attrs)),
			children);
	});
var $author$project$UI$Link$navListItemMutedClass = 'block w-full rounded py-[0.28rem] px-[0.55rem] -ml-[0.55rem] no-underline !text-[var(--fg-muted)] hover:!text-[var(--link)] hover:bg-[var(--link-bg-hover)]';
var $author$project$UI$Link$navListItemMuted = F3(
	function (emphasized, attrs, children) {
		return A2(
			$elm$html$Html$a,
			$author$project$UI$FocusVisible$on(
				A2(
					...
					$author$project$TW$cls(
						_Utils_ap(
							$author$project$UI$Link$navListItemMutedClass,
							emphasized ? ' font-bold' : '')),
					attrs)),
			children);
	});
var $author$project$UI$pageActionsSidebarStackAttr = $author$project$TW$cls('flex flex-col gap-[0.35rem]');
var $author$project$UI$pageActionsTopBorderBlockAttr = $author$project$TW$cls('mt-4 -mx-[0.85rem] px-[0.85rem] border-t border-[var(--border)] pt-4');
var $author$project$UI$sideNavListClass = 'list-none m-0 p-0 flex flex-col gap-[0.2rem] w-full';
var $author$project$UI$sideNavListAttr = $author$project$TW$cls($author$project$UI$sideNavListClass);
var $author$project$UI$sideNavNavClass = 'w-full';
var $author$project$UI$sideNavNavAttr = $author$project$TW$cls($author$project$UI$sideNavNavClass);
var $author$project$UI$sideNavStackClass = 'flex flex-col gap-y-[0.9rem] w-full text-[var(--fg-muted)] text-[1rem] [font-family:var(--font-serif)] leading-[1.35]';
var $author$project$UI$sideNavStackAttr = $author$project$TW$cls($author$project$UI$sideNavStackClass);
var $author$project$UI$sidebarContainerClass = 'min-h-0 self-stretch overflow-y-auto overscroll-contain flex flex-col gap-y-[0.9rem] bg-transparent border-0 py-[0.85rem] pl-[0.85rem] pr-0';
var $author$project$UI$sidebarContainerAttr = $author$project$TW$cls($author$project$UI$sidebarContainerClass);
var $author$project$UI$Heading$sidebarHeadingClass = 'm-0 mb-[0.35rem] text-[0.82rem] [font-family:var(--font-serif)] font-semibold ' + ($author$project$UI$Heading$sidebarSubheadingTrackingClass + ' text-[var(--fg-muted)]');
var $author$project$UI$Heading$sidebarHeading = function (label) {
	return A2(
		$elm$html$Html$h2,
		_List_fromArray(
			[
				$author$project$TW$cls($author$project$UI$Heading$sidebarHeadingClass)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(label)
...
var $author$project$UI$Link$sidebarLinkClass = '[font-family:var(--font-ui)] text-[0.8125rem] text-[var(--link)] hover:text-[var(--link-hover)] hover:bg-[var(--link-bg-hover)] underline underline-offset-[2px]';
var $author$project$UI$Link$sidebarLink = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$a,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Link$sidebarLinkClass),
				attrs),
			children);
	});
var $author$project$UI$sidebarNavSectionBodyClass = 'pl-[0.35rem]';
var $author$project$UI$sidebarNavSectionBodyAttr = $author$project$TW$cls($author$project$UI$sidebarNavSectionBodyClass);
var $author$project$UI$sidebarTocListIndentAttr = $author$project$TW$cls('flex flex-col gap-[0.25rem]');
var $author$project$UI$sidebarTocListRootAttr = $author$project$TW$cls('my-0');
var $author$project$Chapters$Navigation$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			'sidebarHeading',
			$author$project$UI$Heading$sidebarHeading('Related Pages')),
			_Utils_Tuple2(
			'sidebarLink',
			A2(
				$author$project$UI$Link$sidebarLink,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('#')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Link to another page')
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Table of Contents entry')
					]))),
			_Utils_Tuple2(
			'sideNavItemLink — normal',
			A3(
				$author$project$UI$Link$navListItem,
				false,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('#')
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Navigation item')
					]))),
			_Utils_Tuple2(
			...
			A3(
				$author$project$UI$Link$navListItemMuted,
				false,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('#')
			...
			A3(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Admin (emphasized)')
					]))),
			_Utils_Tuple2(
			'wikiSessionLogoutButton (button styled as link)',
			A2(
				$author$project$UI$Button$inlineLinkButton,
				_List_Nil,
				_List_fromArray(
					[
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$layoutLeftNavAsideAttr,
						A2($elm$html$Html$Attributes$style, 'width', '14rem')
					]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$sideNavStackAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$nav,
								_List_fromArray(
									[$author$project$UI$sideNavNavAttr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$ul,
										_List_fromArray(
											[$author$project$UI$sideNavListAttr]),
										_List_fromArray(
											[
												A2(
												$elm$html$Html$li,
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$sidebarContainerAttr,
						A2($elm$html$Html$Attributes$style, 'width', '14rem')
					]),
				_List_fromArray(
					[
						$author$project$UI$Heading$sidebarHeading('Table of Contents'),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$sidebarNavSectionBodyAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$sidebarTocListRootAttr]),
								_List_fromArray(
									[
										A2(
										$elm$html$Html$div,
										_List_fromArray(
											[
												$author$project$TW$cls('flex flex-col gap-[0.25rem]')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$href('#intro')
													]),
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$href('#setup')
													]),
												_List_fromArray(
													[
						...
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$pageActionsTopBorderBlockAttr]),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[$author$project$UI$pageActionsSidebarStackAttr]),
								_List_fromArray(
									[
										A2(
										$author$project$UI$Button$button,
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('#h1')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Top-level heading')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[$author$project$UI$sidebarTocListIndentAttr]),
						_List_fromArray(
							[
								A2(
								$author$project$UI$Link$sidebarLink,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('#h2a')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Sub-heading A')
									])),
								A2(
								$author$project$UI$Link$sidebarLink,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('#h2b')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Sub-heading B')
									]))
							]))
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Navigation & Sidebar'));
var $author$project$UI$PanelHeader$Primary = {$: 'Primary'};
var $author$project$UI$PanelHeader$Secondary = {$: 'Secondary'};
var $author$project$UI$PanelHeader$rowClass = 'shrink-0 px-4 py-2 border-b border-[var(--border-subtle)]';
var $author$project$UI$PanelHeader$row = function (child) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class($author$project$UI$PanelHeader$rowClass)
			]),
		_List_fromArray(
			[child]));
};
var $author$project$UI$PanelHeader$view = function (cfg) {
	var _v0 = cfg.kind;
	if (_v0.$ === 'Primary') {
		return $author$project$UI$PanelHeader$row(
			A2(
				$author$project$UI$Heading$panelHeadingPrimary,
				_List_Nil,
				_List_fromArray(
...
var $author$project$Chapters$PanelHeader$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$TW$cls('flex flex-col max-w-md border border-[var(--border-subtle)] rounded-lg overflow-hidden bg-[var(--input-bg)]')
					]),
				_List_fromArray(
					[
						$author$project$UI$PanelHeader$view(
						{kind: $author$project$UI$PanelHeader$Primary, text: 'EDITOR'}),
						$author$project$UI$PanelHeader$view(
						{kind: $author$project$UI$PanelHeader$Secondary, text: 'LIVE PREVIEW'}),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$author$project$TW$cls('p-2 text-[0.85rem] text-[var(--fg-muted)]')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Markdown / preview columns use this chrome.')
							]))
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.PanelHeader'));
var $author$project$UI$ResultNotice$fromResult = F2(
	function (cfg, maybeResult) {
		if (maybeResult.$ === 'Nothing') {
			...
			if (maybeResult.a.$ === 'Ok') {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id(cfg.id + '-success')
						]),
					_List_fromArray(
						[
							A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id(cfg.id + '-error')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$id(cfg.id + '-error-text')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(
...
var $author$project$Chapters$ResultNotice$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			'ResultNotice.fromResult - Nothing',
			A2(
				$author$project$UI$ResultNotice$fromResult,
				{errToText: $elm$core$Basics$identity, id: 'book-result-a', okText: 'Done.'},
				$elm$core$Maybe$Nothing)),
			_Utils_Tuple2(
			'ResultNotice.fromResult - Ok',
			A2(
				$author$project$UI$ResultNotice$fromResult,
				{errToText: $elm$core$Basics$identity, id: 'book-result-b', okText: 'Signed in.'},
				$elm$core$Maybe$Just(
					$elm$core$Result$Ok(_Utils_Tuple0)))),
			_Utils_Tuple2(
			'ResultNotice.fromResult - Err',
			A2(
				$author$project$UI$ResultNotice$fromResult,
				{errToText: $elm$core$Basics$identity, id: 'book-result-c', okText: 'Done.'},
				$elm$core$Maybe$Just(
					$elm$core$Result$Err('Invalid password.'))))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.ResultNotice'));
var $author$project$UI$backlinksSectionClass = 'max-w-[52rem]';
var $author$project$UI$backlinksSectionAttr = $author$project$TW$cls($author$project$UI$backlinksSectionClass);
var $elm$html$Html$section = _VirtualDom_node('section');
var $author$project$UI$SidebarSection$section = function (cfg) {
	return A2(
		$elm$html$Html$section,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id(cfg.id),
				$author$project$UI$backlinksSectionAttr
			]),
		_List_fromArray(
			[
				$author$project$UI$Heading$sidebarHeading(cfg.title),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$sidebarNavSectionBodyAttr]),
...
var $author$project$Chapters$SidebarSection$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$TW$cls('max-w-[14rem]')
					]),
				_List_fromArray(
					[
						$author$project$UI$SidebarSection$section(
						{
							body: $author$project$UI$EmptyState$paragraph(
								{id: 'book-sidebar-empty', text: 'No backlinks.'}),
							id: 'book-sidebar-demo',
							title: 'Backlinks'
						})
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.SidebarSection'));
var $author$project$Chapters$StatusBadge$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.StatusBadge'));
var $author$project$Chapters$SubmissionActions$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$TW$cls('flex justify-end gap-2 border-t border-[var(--border-subtle)] px-4 py-2 bg-[var(--bg)]')
					]),
				$author$project$UI$SubmissionActions$primaryPairButtons(
					{saveDraftAttrs: _List_Nil, submitAttrs: _List_Nil, submitLabel: 'Create'})))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.SubmissionActions'));
var $author$project$UI$TableAlignMiddle = {$: 'TableAlignMiddle'};
var $author$project$UI$TableAuto = {$: 'TableAuto'};
var $author$project$UI$TableFullMax72 = {$: 'TableFullMax72'};
var $author$project$UI$tableHeaderCellMiddleClass = 'px-[0.55rem] py-[0.22rem] text-left align-middle bg-[var(--chrome-bg)] font-semibold border-b border-[var(--border)]';
var $author$project$UI$headerClassForVerticalAlign = function (align) {
	if (align.$ === 'TableAlignTop') {
		return $author$project$UI$tableHeaderCellClass;
	} else {
		return $author$project$UI$tableHeaderCellMiddleClass;
	}
};
var $author$project$UI$tableAutoClass = 'w-auto ' + $author$project$UI$tableBaseClass;
var $author$project$UI$tableFullWidthMax72Class = 'w-full max-w-[72rem] ' + $author$project$UI$tableBaseClass;
var $author$project$UI$tableWidthClass = function (width) {
	if (width.$ === 'TableAuto') {
		return $author$project$UI$tableAutoClass;
	} else {
		return $author$project$UI$tableFullWidthMax72Class;
	}
};
var $author$project$UI$table = F3(
	function (width, tableExtraAttrs, config) {
		return A2(
			$elm$html$Html$table,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls(
					$author$project$UI$tableWidthClass(width)),
				tableExtraAttrs),
			_List_fromArray(
				[
					A2(
								...
								function (h) {
									return A2(
										...
										A2(
											$elm$core$List$cons,
											$author$project$TW$cls(
												$author$project$UI$headerClassForVerticalAlign(config.headerAlign)),
											h.extraAttrs),
										h.children);
								},
								config.headers))
						])),
					A2($elm$html$Html$tbody, config.tbodyAttrs, config.rows)
				]));
	});
var $author$project$UI$tableHeaderText = function (label) {
	return {
		children: _List_fromArray(
			[
				$elm$html$Html$text(label)
			]),
		extraAttrs: _List_Nil
	};
};
var $author$project$UI$trStriped = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$tr,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$tableStripedRowClass),
				attrs),
			children);
	});
var $author$project$Chapters$Tables$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A3(
				...
				$author$project$UI$TableAuto,
				_List_Nil,
				{
					headerAlign: $author$project$UI$TableAlignTop,
					headerRowAttrs: _List_Nil,
					headers: _List_fromArray(
						[
							$author$project$UI$tableHeaderText('Name'),
							$author$project$UI$tableHeaderText('Status'),
							$author$project$UI$tableHeaderText('Date')
						]),
					rows: _List_fromArray(
						[
							A2(
							$author$project$UI$trStriped,
							_List_Nil,
							_List_fromArray(
								[
									A3(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('2024-03-20')
										]))
								]))
						]),
					tbodyAttrs: _List_Nil,
					theadAttrs: _List_Nil
				})),
			_Utils_Tuple2(
			...
			A3(
				...
				_List_Nil,
				{
					headerAlign: $author$project$UI$TableAlignMiddle,
					headerRowAttrs: _List_Nil,
					headers: _List_fromArray(
						[
							$author$project$UI$tableHeaderText('Name'),
							$author$project$UI$tableHeaderText('Actions')
						]),
					rows: _List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignMiddle,
									_List_Nil,
									_List_fromArray(
										[
			...
			A3(
				$author$project$UI$table,
				$author$project$UI$TableFullMax72,
				_List_Nil,
				{
					headerAlign: $author$project$UI$TableAlignTop,
					headerRowAttrs: _List_Nil,
					headers: _List_fromArray(
						[
							$author$project$UI$tableHeaderText('Timestamp'),
							$author$project$UI$tableHeaderText('User'),
							$author$project$UI$tableHeaderText('Action')
						]),
					rows: _List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('2024-01-01 10:30:00')
										])),
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignTop,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Created page')
										]))
								])),
							A2(
							$author$project$UI$trStriped,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('2024-01-02 14:15:22')
										])),
									A3(
									$author$project$UI$tableTd,
									$author$project$UI$TableAlignTop,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Edited page')
										]))
								]))
						]),
					tbodyAttrs: _List_Nil,
	...
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Tables'));
var $author$project$UI$Textarea$formClass = $author$project$UI$Textarea$formShellClass + ' min-h-[5rem]';
var $author$project$UI$Textarea$form = function (attrs) {
	return $author$project$UI$FocusVisible$on(
		A2(
			$elm$core$List$cons,
			$author$project$TW$cls($author$project$UI$Textarea$formClass),
			attrs));
};
var $author$project$Chapters$Textarea$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$textarea,
				$author$project$UI$Textarea$form(
					_List_fromArray(
						[
							$elm$html$Html$Attributes$placeholder('Tall textarea...')
						])),
				_List_Nil)),
			_Utils_Tuple2(
			'formCompactAttr',
			A2(
				...
				$author$project$UI$Textarea$formCompact(
					_List_fromArray(
						[
							$elm$html$Html$Attributes$placeholder('Compact textarea...')
						])),
				_List_Nil)),
			_Utils_Tuple2(
			...
			A2(
				...
				$author$project$UI$Textarea$form(
					_List_fromArray(
						[
							$elm$html$Html$Attributes$placeholder('Configurable via attrs'),
			...
			A2(
				...
				$author$project$UI$Textarea$formCompact(
					_List_fromArray(
						[
							$elm$html$Html$Attributes$placeholder('Disabled compact textarea'),
							$elm$html$Html$Attributes$disabled(true)
						])),
				_List_Nil)),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Readonly markdown style used in review flow.')
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('UI.Textarea'));
var $author$project$Chapters$Typography$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('A content link')
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Normal-weight link')
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Bold-weight link')
					]))),
			_Utils_Tuple2(
			'contentHeading2',
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('A Content Heading')
					]))),
			_Utils_Tuple2(
			'contentParagraph',
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('This is a content paragraph. It uses the serif font for body-copy style rendering, with comfortable spacing and line-height from the design system.')
					]))),
			_Utils_Tuple2(
			'contentLabel',
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Form field label')
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Typography'));
var $elm$html$Html$article = _VirtualDom_node('article');
var $author$project$UI$backlinksListClass = 'list-none m-0 p-0 flex flex-col gap-[0.25rem]';
var $author$project$UI$backlinksListAttr = $author$project$TW$cls($author$project$UI$backlinksListClass);
var $author$project$UI$Link$cardTitleClass = 'no-underline hover:underline underline-offset-[0.2em]';
var $author$project$UI$Link$cardTitle = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$a,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls($author$project$UI$Link$cardTitleClass),
				attrs),
			children);
	});
var $author$project$UI$Link$listItemTight = F2(
	function (attrs, children) {
		return A2(
			$elm$html$Html$li,
			A2(
				$elm$core$List$cons,
				$author$project$TW$cls('m-0 leading-[1.3]'),
				attrs),
			children);
	});
var $author$project$UI$tagPillClass = function (slugExists) {
	return 'inline-block px-[0.55rem] py-[0.15rem] rounded-full border text-[0.8125rem] no-underline transition-colors duration-150 [font-family:var(--font-ui)] font-semibold ' + ((slugExists ? 'border-[var(--tag-border)] bg-[var(--tag-bg)] text-[var(--tag-fg)] hover:brightness-[0.96] ' : 'border-[var(--border-dash)] bg-[var(--bg)] text-[var(--fg-muted)] opacity-60 cursor-default ') + $author$project$UI$focusVisibleRingClass);
};
var $author$project$UI$tagPillAttr = function (slugExists) {
	return $author$project$TW$cls(
		$author$project$UI$tagPillClass(slugExists));
};
var $author$project$UI$tagPillsListAttr = $author$project$TW$cls('list-none m-0 p-0 flex flex-wrap gap-[0.35rem]');
var $author$project$UI$todosListDiscAttr = $author$project$TW$cls('m-0 pl-[1.15rem] list-disc [font-family:var(--font-ui)] text-[0.8125rem] leading-[1.35]');
var $author$project$UI$wikiCatalogCardClass = 'border border-[var(--border-subtle)] bg-[var(--chrome-bg)] rounded-xl p-4 [font-family:var(--font-serif)] shadow-[0_4px_16px_rgba(73,103,49,0.07)] hover:shadow-[0_8px_24px_rgba(73,103,49,0.12)] transition-shadow duration-200';
var $author$project$UI$wikiCatalogCardAttr = $author$project$TW$cls($author$project$UI$wikiCatalogCardClass);
var $author$project$UI$wikiCatalogCardSlugEmClass = 'text-[0.9rem] font-normal opacity-80';
var $author$project$UI$wikiCatalogCardSlugEmAttr = $author$project$TW$cls($author$project$UI$wikiCatalogCardSlugEmClass);
var $author$project$UI$wikiCatalogCardSummaryClass = 'm-0 mt-2 min-h-[1.25rem]';
var $author$project$UI$wikiCatalogCardSummaryAttr = $author$project$TW$cls($author$project$UI$wikiCatalogCardSummaryClass);
var $author$project$UI$wikiCatalogCardTitleClass = 'm-0 text-[1.1rem] font-semibold';
var $author$project$UI$wikiCatalogCardTitleAttr = $author$project$TW$cls($author$project$UI$wikiCatalogCardTitleClass);
var $author$project$UI$wikiCatalogGridClass = 'grid w-full max-w-[72rem] grid-cols-3 gap-3';
var $author$project$UI$wikiCatalogGridAttr = $author$project$TW$cls($author$project$UI$wikiCatalogGridClass);
var $author$project$UI$wikiRightRailSectionCardClass = 'rounded-2xl border border-[var(--border-subtle)] bg-[var(--chrome-bg)] p-3 shadow-[0_6px_18px_rgba(73,103,49,0.06)]';
var $author$project$UI$wikiRightRailSectionCardAttr = $author$project$TW$cls($author$project$UI$wikiRightRailSectionCardClass);
var $author$project$UI$wikiRightRailTocNudgeAttr = $author$project$TW$cls('-mx-[0.85rem] px-[0.85rem]');
var $author$project$Chapters$WikiComponents$chapter_ = A2(
	$dtwrks$elm_book$ElmBook$Chapter$renderComponentList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$tagPillAttr(true),
						$elm$html$Html$Attributes$href('#')
					]),
				_List_fromArray(
					[
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$tagPillAttr(false)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('unknown-tag')
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$ul,
				_List_fromArray(
					[$author$project$UI$tagPillsListAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('type-safety')
									]))
							])),
						A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('missing-tag')
									]))
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$Heading$sidebarHeading('Backlinks'),
						A2(
						$elm$html$Html$ul,
						_List_fromArray(
							[$author$project$UI$backlinksListAttr]),
						_List_fromArray(
							[
								A2(
								$author$project$UI$Link$listItemTight,
								_List_Nil,
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Getting Started with Elm')
											]))
									])),
								A2(
								$author$project$UI$Link$listItemTight,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Missing Page (red)')
											]))
									]))
							]))
					]))),
			...
			A2(
				...
				_List_fromArray(
					[$author$project$UI$wikiCatalogCardAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$h3,
						_List_fromArray(
							[$author$project$UI$wikiCatalogCardTitleAttr]),
						_List_fromArray(
							[
								A2(
								$author$project$UI$Link$cardTitle,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('#')
									]),
								_List_fromArray(
									[
										...
										$elm$html$Html$em,
										_List_fromArray(
											[$author$project$UI$wikiCatalogCardSlugEmAttr]),
										_List_fromArray(
											[
												$elm$html$Html$text(' #the-elm-architecture')
											]))
						...
						$elm$html$Html$p,
						_List_fromArray(
							[$author$project$UI$wikiCatalogCardSummaryAttr]),
						_List_fromArray(
							[
								$elm$html$Html$text('A simple pattern for architecting web apps.')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$wikiCatalogGridAttr]),
				A2(
					$elm$core$List$map,
					function (_v0) {
						var title = _v0.a;
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Short wiki description.')
										]))
								]));
					},
					_List_fromArray(
						[
							_Utils_Tuple2('Elm Patterns', 'elm-patterns'),
							_Utils_Tuple2('Functional Wiki', 'functional-wiki'),
							_Utils_Tuple2('Type Systems', 'type-systems')
						])))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$ol,
				_List_fromArray(
					[$author$project$UI$todosListDiscAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Fix the authentication flow')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Add search functionality')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Write integration tests')
							]))
					]))),
			_Utils_Tuple2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$UI$wikiRightRailTocNudgeAttr,
						$author$project$TW$cls('bg-[var(--chrome-bg)] p-2 text-[var(--fg-muted)] text-[0.9rem]')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Right-rail content with corrected side inset')
					]))),
			_Utils_Tuple2(
			...
			A2(
				$elm$html$Html$div,
				_List_fromArray(
					[$author$project$UI$wikiRightRailSectionCardAttr]),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$h3,
						_List_fromArray(
							[
								$author$project$TW$cls('m-0 mb-1 text-[0.82rem] font-semibold tracking-[0.04em] text-[var(--fg-muted)]')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Section Card')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
							[
								$author$project$TW$cls('m-0 text-[0.9rem] text-[var(--fg-muted)]')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Rounded card shell for right-rail ToC/tags/backlinks sections.')
							]))
					])))
		]),
	$dtwrks$elm_book$ElmBook$Chapter$chapter('Wiki Components'));
var $dtwrks$elm_book$ElmBook$StatefulOptions$initialState = F2(
	function (state, options) {
		return _Utils_update(
			options,
			{
				initialState: $elm$core$Maybe$Just(
					F2(
						function (_v0, _v1) {
							return state;
						}))
...
var $author$project$SharedState$initialState = {chip1: false, chip2: true, chip3: false};
...
var $dtwrks$elm_book$ElmBook$ThemeOptions$navBackground = F2(
	function (v, theme) {
		return _Utils_update(
			theme,
			{navBackground: v});
...
var $dtwrks$elm_book$ElmBook$Internal$Application$init = F4(
	function (config, flags, url_, navKey) {
		...
		switch (msg.$) {
							...
							function (fallback) {
								return _Utils_Tuple2(
									...
									A2(
										$elm$browser$Browser$Navigation$pushUrl,
										model.navKey,
										hashBasedNavigation_ ? ('#' + $dtwrks$elm_book$ElmBook$Internal$Chapter$chapterUrl(fallback)) : $dtwrks$elm_book$ElmBook$Internal$Chapter$chapterUrl(fallback)));
							},
							A2($elm$core$Array$get, 0, config.chapters)));
				} else {
					var urlChapter = A2(
			...
			case 'KeyEnter':
				if (!model.isSearching) {
					...
					var filteredChapters = A2($dtwrks$elm_book$ElmBook$Internal$Application$searchChapters, model.search, config.chapters);
					var targetChapter = $elm$core$Array$isEmpty(filteredChapters) ? $elm$core$Maybe$Nothing : A2(
						$elm$core$Array$get,
						A2(
							$elm$core$Basics$modBy,
							$elm$core$Array$length(filteredChapters),
...
var $dtwrks$elm_book$ElmBook$UI$Markdown$defaultRenderer = function (hashBasedNavigation) {
	return {
		...
		heading: function (_v2) {
			...
			if (hashBasedNavigation) {
				...
				var headingId = $dtwrks$elm_book$ElmBook$Internal$Helpers$toSlug(rawText);
				return A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href('#' + headingId),
									$elm$html$Html$Attributes$id(headingId),
									$elm$html$Html$Attributes$class('elm-book-md__heading-anchor')
								]),
							_List_fromArray(
								[
									tag(children)
...
var $dtwrks$elm_book$ElmBook$UI$Markdown$componentRenderer = F4(
	function (hashBasedNavigation, chapterTitle, chapterComponents, componentOptions) {
		var defaultRenderer_ = $dtwrks$elm_book$ElmBook$UI$Markdown$defaultRenderer(hashBasedNavigation);
		return _Utils_update(
			defaultRenderer_,
			{
															...
															A2(
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$Attributes$class('elm-book-sans elm-book__component-error')
																			]),
																		_List_fromArray(
																			[
																				$elm$html$Html$text(
...
var $dtwrks$elm_book$ElmBook$UI$Markdown$view = F5(
	function (hashBasedNavigation, chapterTitle, chapterComponents, componentOptions, chapterContent) {
		return function (result) {
			if (result.$ === 'Ok') {
				var children = result.a;
				return A2(
					$elm$html$Html$article,
					_List_Nil,
					_List_fromArray(
			...
			A2(
				...
				function (blocks) {
					return A2(
						...
						A4($dtwrks$elm_book$ElmBook$UI$Markdown$componentRenderer, hashBasedNavigation, chapterTitle, chapterComponents, componentOptions),
						blocks);
				},
				A2(
					$elm$core$Result$mapError,
					function (errors) {
						return A2(
							$elm$core$String$join,
							'\n',
							A2($elm$core$List$map, $dillonkearns$elm_markdown$Markdown$Parser$deadEndToString, errors));
					},
					$dillonkearns$elm_markdown$Markdown$Parser$parse(chapterContent))));
	});
var $dtwrks$elm_book$ElmBook$UI$Chapter$view = function (props) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A5($dtwrks$elm_book$ElmBook$UI$Markdown$view, props.hashBasedNavigation, props.title, props.components, props.componentOptions, body)
			]));
};
							...
							return $dtwrks$elm_book$ElmBook$UI$Nav$view(
								{
									...
									preSelected: (model.isSearching && ($elm$core$Array$length(chaptersList) > 0)) ? A2(
										$elm$core$Maybe$map,
										$dtwrks$elm_book$ElmBook$Internal$Chapter$chapterNavUrl(hashBasedNavigation),
										A2(
											$elm$core$Array$get,
					...
					return $elm$core$Platform$Sub$batch(
						_List_fromArray(
							[
								...
								A2($elm$core$Maybe$map, config.statefulOptions.subscriptions, model.state))
							]));
				},
				update: F2(
					function (msg, model) {
...
var $author$project$Book$main = A2(
	...
	_List_fromArray(
		[
			...
			'Typography',
			_List_fromArray(
				[$author$project$Chapters$Typography$chapter_])),
			_Utils_Tuple2(
			'Form Controls',
			_List_fromArray(
				[$author$project$Chapters$FormControls$chapter_, $author$project$Chapters$FormControls$chapterChips, $author$project$Chapters$Textarea$chapter_, $author$project$Chapters$Button$chapter_, $author$project$Chapters$FocusVisible$chapter_, $author$project$Chapters$Link$chapter_, $author$project$Chapters$IconInput$chapter_])),
			_Utils_Tuple2(
			'UI Shell & Feedback',
			_List_fromArray(
				[$author$project$Chapters$EditorShell$chapter_, $author$project$Chapters$Heading$chapter_, $author$project$Chapters$StatusBadge$chapter_, $author$project$Chapters$PanelHeader$chapter_, $author$project$Chapters$FormActionFooter$chapter_, $author$project$Chapters$SubmissionActions$chapter_, $author$project$Chapters$ResultNotice$chapter_, $author$project$Chapters$EmptyState$chapter_, $author$project$Chapters$AsyncState$chapter_, $author$project$Chapters$SidebarSection$chapter_])),
			_Utils_Tuple2(
			'Navigation & Sidebar',
			_List_fromArray(
				[$author$project$Chapters$Navigation$chapter_])),
			_Utils_Tuple2(
			'Tables',
			_List_fromArray(
				[$author$project$Chapters$Tables$chapter_])),
			_Utils_Tuple2(
			'App Header',
			_List_fromArray(
				[$author$project$Chapters$AppHeader$chapter_])),
			_Utils_Tuple2(
			'Markdown',
			_List_fromArray(
				[$author$project$Chapters$MarkdownElements$chapter_])),
			_Utils_Tuple2(
			'Wiki',
			_List_fromArray(
				[$author$project$Chapters$WikiComponents$chapter_])),
			_Utils_Tuple2(
			'Graph',
			_List_fromArray(
				[$author$project$Chapters$Graph$chapter_])),
			_Utils_Tuple2(
			'Admin & Audit',
			_List_fromArray(
				[$author$project$Chapters$Admin$chapter_, $author$project$Chapters$Admin$chapterAuditFilters, $author$project$Chapters$Admin$chapterSubmissionFlow]))
		]),
	A2(
		...
		_List_fromArray(
			[
				...
				$dtwrks$elm_book$ElmBook$ThemeOptions$background('#fafaf2'),
				$dtwrks$elm_book$ElmBook$ThemeOptions$accent('#496731'),
				$dtwrks$elm_book$ElmBook$ThemeOptions$navBackground('#f4f4ec'),
				$dtwrks$elm_book$ElmBook$ThemeOptions$navAccent('#44483d'),
				$dtwrks$elm_book$ElmBook$ThemeOptions$navAccentHighlight('#36521f')
			]),
		A2(
			$dtwrks$elm_book$ElmBook$withStatefulOptions,
			_List_fromArray(
				[
					$dtwrks$elm_book$ElmBook$StatefulOptions$initialState($author$project$SharedState$initialState)
				]),
			$dtwrks$elm_book$ElmBook$book('UI.elm'))));
_Platform_export({'Book':{'init':$author$project$Book$main($elm$json$Json$Decode$value)(0)}});}(this));