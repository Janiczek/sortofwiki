module Evergreen.V20.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V20.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V20.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V20.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V20.Page.Slug
    , markdown : String
    , tags : List Evergreen.V20.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V20.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
