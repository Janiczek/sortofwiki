module Evergreen.V28.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V28.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V28.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V28.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V28.Page.Slug
    , markdown : String
    , tags : List Evergreen.V28.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V28.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
