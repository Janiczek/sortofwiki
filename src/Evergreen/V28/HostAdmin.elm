module Evergreen.V28.HostAdmin exposing (..)
...
type CreateHostedWikiError
    ...
    | CreateSlugInvalid Evergreen.V28.Submission.ValidationError
    | CreateWikiNameInvalid WikiNameError
    | CreateWikiSlugTaken
    | CreateInitialAdminInvalid Evergreen.V28.ContributorAccount.RegisterContributorError
...
type UpdateHostedWikiMetadataError
    ...
    | UpdateMetadataWikiSlugInvalid Evergreen.V28.Submission.ValidationError
