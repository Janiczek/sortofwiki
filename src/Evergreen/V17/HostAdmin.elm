module Evergreen.V17.HostAdmin exposing (..)
...
type CreateHostedWikiError
    ...
    | CreateSlugInvalid Evergreen.V17.Submission.ValidationError
    | CreateWikiNameInvalid WikiNameError
    | CreateWikiSlugTaken
    | CreateInitialAdminInvalid Evergreen.V17.ContributorAccount.RegisterContributorError
...
type UpdateHostedWikiMetadataError
    ...
    | UpdateMetadataWikiSlugInvalid Evergreen.V17.Submission.ValidationError
