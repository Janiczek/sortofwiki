module Evergreen.V17.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V17.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V17.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V17.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V17.Page.Slug
    , markdown : String
    , tags : List Evergreen.V17.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V17.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
