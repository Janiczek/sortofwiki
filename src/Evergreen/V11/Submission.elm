module Evergreen.V11.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V11.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V11.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V11.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V11.Page.Slug
    , markdown : String
    , tags : List Evergreen.V11.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V11.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
