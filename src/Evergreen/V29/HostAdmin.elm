module Evergreen.V29.HostAdmin exposing (..)
...
type CreateHostedWikiError
    ...
    | CreateSlugInvalid Evergreen.V29.Submission.ValidationError
    | CreateWikiNameInvalid WikiNameError
    | CreateWikiSlugTaken
    | CreateInitialAdminInvalid Evergreen.V29.ContributorAccount.RegisterContributorError
...
type UpdateHostedWikiMetadataError
    ...
    | UpdateMetadataWikiSlugInvalid Evergreen.V29.Submission.ValidationError
