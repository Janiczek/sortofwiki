module Evergreen.V12.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V12.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V12.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V12.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V12.Page.Slug
    , markdown : String
    , tags : List Evergreen.V12.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V12.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
