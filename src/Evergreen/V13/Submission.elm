module Evergreen.V13.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V13.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V13.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V13.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V13.Page.Slug
    , markdown : String
    , tags : List Evergreen.V13.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V13.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
