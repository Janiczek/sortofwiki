module Evergreen.V26.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V26.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V26.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V26.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V26.Page.Slug
    , markdown : String
    , tags : List Evergreen.V26.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V26.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
