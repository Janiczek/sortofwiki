module Evergreen.V14.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V14.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V14.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V14.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V14.Page.Slug
    , markdown : String
    , tags : List Evergreen.V14.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V14.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
