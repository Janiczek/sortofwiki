module Evergreen.V25.HostAdmin exposing (..)
...
type CreateHostedWikiError
    ...
    | CreateSlugInvalid Evergreen.V25.Submission.ValidationError
    | CreateWikiNameInvalid WikiNameError
    | CreateWikiSlugTaken
    | CreateInitialAdminInvalid Evergreen.V25.ContributorAccount.RegisterContributorError
...
type UpdateHostedWikiMetadataError
    ...
    | UpdateMetadataWikiSlugInvalid Evergreen.V25.Submission.ValidationError
