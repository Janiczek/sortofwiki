module Evergreen.V25.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V25.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V25.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V25.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V25.Page.Slug
    , markdown : String
    , tags : List Evergreen.V25.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V25.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
