module Evergreen.V4.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V4.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V4.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V4.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V4.Page.Slug
    , markdown : String
    , tags : List Evergreen.V4.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V4.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
