module Evergreen.V16.HostAdmin exposing (..)
...
type CreateHostedWikiError
    ...
    | CreateSlugInvalid Evergreen.V16.Submission.ValidationError
    | CreateWikiNameInvalid WikiNameError
    | CreateWikiSlugTaken
    | CreateInitialAdminInvalid Evergreen.V16.ContributorAccount.RegisterContributorError
...
type UpdateHostedWikiMetadataError
    ...
    | UpdateMetadataWikiSlugInvalid Evergreen.V16.Submission.ValidationError
