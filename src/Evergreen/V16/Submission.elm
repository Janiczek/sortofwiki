module Evergreen.V16.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V16.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V16.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V16.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V16.Page.Slug
    , markdown : String
    , tags : List Evergreen.V16.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V16.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
