module Evergreen.V32.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V32.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V32.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V32.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V32.Page.Slug
    , markdown : String
    , tags : List Evergreen.V32.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V32.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
