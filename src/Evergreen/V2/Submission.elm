module Evergreen.V2.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V2.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V2.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V2.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V2.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
