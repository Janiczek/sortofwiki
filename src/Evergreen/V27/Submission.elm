module Evergreen.V27.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V27.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V27.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V27.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V27.Page.Slug
    , markdown : String
    , tags : List Evergreen.V27.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V27.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
