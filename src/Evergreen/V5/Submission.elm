module Evergreen.V5.Submission exposing (..)
...
type alias ReviewQueueItem =
    ...
    , maybePageSlug : Maybe Evergreen.V5.Page.Slug
    }
...
type alias ContributorView =
    ...
    , maybeNewPageSlug : Maybe Evergreen.V5.Page.Slug
    , maybeEditPageSlug : Maybe Evergreen.V5.Page.Slug
    }
...
type alias NewPageBody =
    { pageSlug : Evergreen.V5.Page.Slug
    , markdown : String
    , tags : List Evergreen.V5.Page.Slug
    }
...
type alias Submission =
    ...
    , authorId : Evergreen.V5.ContributorAccount.Id
    , kind : Kind
    , status : Status
    , reviewerNote : Maybe String
    }
